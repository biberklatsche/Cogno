...
module.exports = {
  forbidden: [
    ...
    {
      name: "ui-kit-is-isolated",
      severity: "error",
      comment: "ui-kit darf keine anderen internen Module importieren.",
      from: { path: "^src/ui-kit/" },
      to: { path: "^src/(app|core-sdk|core-host|open-features|pro-features)/" },
    },
    {
      name: "open-features-only-core-sdk",
      severity: "error",
      comment: "open-features darf nur gegen core-sdk und ui-kit entwickeln.",
    ...
    },
    {
      ...
      severity: "error",
      comment: "pro-features darf nur gegen core-sdk und ui-kit entwickeln.",
    ...
    },
    {
      ...
      to: {
        ...
        path: "^@cogno/(?!app$|core-sdk$|core-host$|ui-kit$|open-features$|pro-features$).+",
      },
    },
  ],
  options: {
