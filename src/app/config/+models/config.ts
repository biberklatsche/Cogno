...
export const DEFAULT_KEYBINDS: Keybinds = [
    ...
    'Command+W:close_tab',
    'Command+Shift+W:close_other_tabs',
    'Command+Shift+Q:close_all_tabs',
    'Command+Shift+<:split_vertical',
    'Command+Shift+-:split_horizontal',
    'Command+Shift+U:unsplit',
    'Command+Shift+P:swap_panes',
    'Command+C:abort_task',
    'Command+Shift+C:abort_all_tasks',
    'Command+C:copy',
    'Command+X:cut',
    'Command+F:find',
    'Command+Y:clear_line',
    'Command+M:clear_line_to_end',
    'Command+N:clear_line_to_start',
    'Command+,:delete_previous_word',
    'Command+.:delete_next_word',
    'Command+Right:go_to_next_word',
    'Command+Left:go_to_previous_word',
    'Command+T:new_tab',
    'Command+Shift+D:duplicate_tab',
    'Command+V:paste',
    'Command+Space:show_autocompletion',
    'Command+Shift+H:show_paste_history',
    'Command+K:show_key_tips',
    'Command+Shift+K:show_context_key_tips',
    'Command+Alt+Right:next_argument',
    'Command+Alt+Left:previous_argument',
    'Command+Shift+S:open_settings',
    'Command+1:open_shell_1',
    'Command+2:open_shell_2',
    'Command+3:open_shell_3',
    ...
    'Command+8:open_shell_8',
    'Command+9:open_shell_9',
    'Command+Shift+Up:scroll_to_previous_command',
    'Command+Shift+Down:scroll_to_next_command',
    'Command+Alt+Up:scroll_to_previous_bookmark',
    'Command+Alt+Down:scroll_to_next_bookmark',
    'Shift+Right:select_text_right',
    'Shift+Left:select_text_left',
    'Command+Shift+Right:select_word_right',
    'Command+Shift+Left:select_word_left',
    'Shift+End:select_text_to_end_of_line',
    'Shift+Home:select_text_to_start_of_line',
    'Command+Shift+F12:open_dev_tools',
    'Command+Shift+F:inject_password'
]
