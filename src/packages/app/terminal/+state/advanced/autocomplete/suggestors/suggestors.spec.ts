  ...
  it("HistoryDirectorySuggestor filters current dir and parent traversal suggestions", async () => {
    const persistence = {
      searchDirectories: vi.fn().mockResolvedValue([
        ...
        {
          path: "/Users/larswolfram/projects/app",
          basename: "app",
          visitCount: 5,
          selectCount: 1,
          lastVisitAt: 1,
  ...
  it("HistoryDirectorySuggestor matches multi-token fragments against visited paths", async () => {
    const persistence = {
      searchDirectories: vi.fn().mockResolvedValue([
        ...
        {
          path: "/c/projects/grimace-tools",
          basename: "grimace-tools",
          visitCount: 10,
          selectCount: 2,
          lastVisitAt: 1,
          ...baseDirHistoryRow,
