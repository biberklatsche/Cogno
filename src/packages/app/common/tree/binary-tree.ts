export class BinaryTree<Data> {
    ...
    private static getNode<Data>(node: BinaryNode<Data>, key: string | undefined): BinaryNode<Data> | undefined {
        if (!key || !node) {
            return node;
        }
    ...
    add(leafKey: string | undefined, position: 'l' | 'r', dataParent: Data | undefined = undefined, dataChild: Data | undefined = undefined) {
...
export class BinaryNode<Data> {
    ...
    private firstRecursive(currentNode: BinaryNode<Data>, find: (node: BinaryNode<Data>) => boolean): BinaryNode<Data> | undefined {
        if (find(currentNode)) {
            return currentNode;
        }
        if (!currentNode.isLeaf) {
    ...
    private countLeafsRecursive(currentNode: BinaryNode<Data> | undefined, result: {count: number}) {
        if (currentNode?.isLeaf) {
            result.count++;
            return;
        } else {
    ...
    private flattenRecursive(node: BinaryNode<Data> | undefined, merge: (d1: Data | undefined, d2: Data | undefined) => Data | undefined) {
