import {ConfigService, ShellProfileEntry} from "../../app-shell/config/+state/config.service";
import {Config} from "../../app-shell/config/+models/config";
import {ShellProfile} from "../../app-shell/config/+models/shell-config";
