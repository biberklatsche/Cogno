...
export * from "./community-application-feature.collection";
export * from "./autocomplete/community-terminal-autocomplete-suggestor-definitions";
...
export * from "./shell/community-shell-definitions";
