...
const instanceNameGenerator = (suggestOptions?: Partial<Suggestion>): Generator => ({
    ...
    subcommands: [
        {
            ...
            subcommands: ["bash", "fish", "powershell", "zsh"].map((subcommandName) => ({
                name: subcommandName,
...
const HELP_COMMAND_DESCRIPTION = "Help provides help for any command in the application";
