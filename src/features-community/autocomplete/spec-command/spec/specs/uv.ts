...
const subcommands: SubcommandSpec[] = [
    ...
    },
    {
        ...
        options: [
            ...
            ...pythonOptions,
            ...cacheOptions,
            ...cacheOptions.filter((option) => option.name === "--cache-dir" || option.name === "--no-cache")
        ]
    },
    {
        name: "tool",
        ...
        options: [
            ...pythonOptions.filter((option) => option.name === "--no-python-downloads" ||
    ...
    },
    {
        ...
        options: [
            ...cacheOptions.filter((option) => option.name === "--cache-dir" || option.name === "--no-cache"),
            ...pythonOptions.filter((option) => option.name === "--python-preference" ||
    ...
    },
    {
        ...
        options: [
            ...pythonOptions,
            ...venvOptions,
            ...indexOptions.filter((option) => option.name !== "--index-strategy" &&
