    ...
    subcommands: [
        {
            ...
            options: [
                pathOption("The path to the light module that contains the page template"),
                {
                    name: "-g",
        ...
        },
        {
            ...
            options: [
                pathOption("The path to the light module where you want to create the app"),
        ...
        },
        {
            ...
            options: [
                ...
                prototypeOption("The name of the prototype variant to create the block")
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                ...
                prototypeOption("The name of the prototype variant to create the light module")
            ]
        },
        {
            name: "create-page",
        ...
        },
        {
            ...
            options: [
                pathOption("The path into which the mgnl-cli-prototypes folder and mgnl-cli.json file are installed")
            ]
        },
        {
            name: "install",
