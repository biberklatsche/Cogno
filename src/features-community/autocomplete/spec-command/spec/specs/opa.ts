    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--claims-file",
          description:
            "Set path of JSON file containing optional claims (see: https://openpolicyagent.org/docs/latest/management/#signature-format)",
          displayName: "claims-file",
          args: {
            name: "claims-file",
          },
        },
        ...
        },
        {
          name: "--signing-plugin",
          description:
            "Name of the plugin to use for signing/verification (see https://openpolicyagent.org/docs/latest/management/#signature-plugin",
          displayName: "signing-plugin",
          args: {
            name: "signing-plugin",
          },
        },
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          args: {
            name: "history",
            default: "/Users/batuhan.apaydin/.opa_history",
          },
        },
        {
          name: "--ignore",
        ...
        },
        {
          ...
          description:
            "Disables anonymous version reporting (see: https://openpolicyagent.org/docs/latest/privacy)",
          displayName: "skip-version-check",
        },
        {
