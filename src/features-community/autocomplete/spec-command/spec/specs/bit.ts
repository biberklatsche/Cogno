        ...
        // { name: "doctor", description: "Diagnose a bit workspace" },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    args: {
                        name: "filePath",
                        description: "Path to archive the workspace including diagnosis info"
                    }
                }
            ]
        },
                    ...
                    options: [
                        {
                            ...
                            args: {
                                name: "string",
                                description: "Show information about the specific services only"
                            }
                        }
                    ]
                },
            ...
            subcommands: [
                ...
                },
                {
                    ...
                    args: [
                        {
                            name: "lane",
                            description: "Lane-name or full lane-id (if remote) to merge into the current lane"
                        },
                        {
                            name: "pattern",
                            description: 'Partially merge the lane - only components that match the specified component-pattern. Component pattern format: component name, component id, or component pattern. Use component pattern to select multiple components. Use comma to separate patterns and "!" to exclude. E.g. "ui/**, !ui/button". Wrap the pattern with quotes'
                        }
                    ],
                    options: [
                        {
                ...
                },
                {
                    ...
                    args: {
                        name: "laneName",
                        description: "Name of the lane from which the readme component should be removed"
                    }
                },
                {
                    name: "import",
                ...
                },
                {
                    ...
                    args: {
                        ...
                        description: 'Component name, component id, or component pattern. Use component pattern to select multiple components. Use comma to separate patterns and "!" to exclude. E.g. "ui/**, !ui/button". Wrap the pattern with quotes'
                    },
                    options: [
                        {
                            name: "--workspace-only",
