...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            args: { name: "shell", description: "Shell type" }
        },
        {
            name: "buildpacks",
        ...
        },
        {
            ...
            args: [
                { name: "name", description: "Name of pipeline" },
                {
                    name: "repo",
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--p95", description: "Desired p95 response time" },
                {
                    name: "--notifications",
        ...
        },
        {
            ...
            options: [
                ...
                { name: ["-s", "--size"], description: "Dyno size" },
                { name: "--type", description: "Process type" },
                {
                    name: ["-x", "--exit-code"],
        ...
        },
        {
            ...
            options: [
                ...
                { name: ["-p", "--pipeline"], description: "Pipeline" },
                {
                    name: ["-a", "--app"],
                    description: "App to run command against",
                    args: { name: "app" }
        ...
        },
        {
            ...
            options: [
                { name: "--as", description: "Name for add-on attachment" },
                {
                    name: "--credential",
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--city", description: "City of owner" },
                {
                    name: "--subject",
        ...
        },
        {
            ...
            options: [
                { name: "--name", description: "Name to check info on" },
                {
                    name: "--endpoint",
        ...
        },
        {
            ...
            options: [
                { name: "--name", description: "Name to remove" },
                { name: "--endpoint", description: "Endpoint to remove" },
                {
                    name: ["-a", "--app"],
                    description: "App to run command against",
                    args: { name: "app" }
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--name", description: "Name to update" },
                { name: "--endpoint", description: "Endpoint to update" },
                {
                    name: ["-a", "--app"],
                    description: "App to run command against",
                    args: { name: "app" }
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--arg", description: "Set build-time variables" },
                {
                    name: "--context-path",
        ...
        },
        {
            ...
            options: [
                { name: "--as", description: "Name of link to create" },
                {
                    name: ["-a", "--app"],
                    description: "App to run command against",
                    args: { name: "app" }
        ...
        },
        {
            ...
            options: [
                ...
                { name: ["-f", "--file"], description: "SQL file to run" },
                { name: "--credential", description: "Credential to use" },
                {
                    name: ["-a", "--app"],
                    description: "App to run command against",
                    args: { name: "app" }
        ...
        },
        {
            ...
            options: [
                { name: "--json", description: "Output in json format" },
                { name: ["-t", "--team"], description: "Team to use" }
            ]
        },
        {
            name: "spaces:create",
        ...
        },
        {
            ...
            options: [
                { name: ["-s", "--space"], description: "Space to destroy" },
                {
                    name: "--confirm",
        ...
        },
        {
            ...
            options: [
                { name: ["-n", "--name"], description: "VPN name" },
                {
                    name: ["-i", "--ip"],
                ...
                { name: ["-s", "--space"], description: "Space name" }
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                { name: ["-r", "--role"], description: "Filter by role" },
                {
                    name: "--pending",
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--json", description: "Output in json format" },
                { name: ["-s", "--space"], description: "Filter by space" },
                {
                    name: ["-p", "--personal"],
        ...
        },
        {
            ...
            args: { name: "plugin", description: "Plugin to inspect" }
        },
        {
        ...
        },
        {
            ...
            args: { name: "path", description: "Path to plugin" }
        },
        {
