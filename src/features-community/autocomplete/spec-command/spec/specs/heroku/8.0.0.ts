...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            args: [{ name: "service:plan" }, { name: "addon" }]
        },
        {
            name: "addons:remove",
            description: "Permanently destroy an add-on resource",
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--team", description: "Team to use" }
            ],
            args: { name: "app" }
        },
        {
        ...
        },
        {
            ...
            options: [
                ...
                { name: "--json", description: "Output in json format" },
                { name: "--space", description: "Filter by space" },
                {
                    name: "--personal",
                    description: "List apps in personal account when a default team is set"
                },
        ...
        { name: "sharing:add", args: { name: "sharin" } },
        {
            name: "sharing:access",
            args: { name: "sharin" }
        },
        ...
        },
        {
            ...
            options: [
                ...
                { name: "min", description: "Minimum number of dynos" },
                { name: "max", description: "Maximum number of dynos" },
        ...
        },
        {
            name: "console",
            options: [
                { name: "--size", description: "Dyno size" },
                {
                    name: "--env",
                    description: "Environment variables to set (use ';' to split multiple vars)"
                },
