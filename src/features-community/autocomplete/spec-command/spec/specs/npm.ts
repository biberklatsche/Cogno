...
export const createNpmSearchHandler = (keywords?: string[]) => async (context: string[], executeShellCommand: ExecuteCommandFunction, shellContext: ShellContext): Promise<Suggestion[]> => {
    ...
    const out = (query: string) => executeShellCommand({
        command: "curl",
    ...
    try {
        ...
        if (shouldGetVersion) {
            ...
            // create versions
            versions.push(...Object.keys(data.versions)
