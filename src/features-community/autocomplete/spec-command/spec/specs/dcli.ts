    ...
    postProcess: function (out) {
        try {
            ...
            return devices.map((device) => ({
                ...
                description: `Last activity: ${unixToDateString(device.lastActivityDateUnix)}`,
    ...
    postProcess: function (out) {
        try {
            ...
            return credentials.map((credential) => ({
                ...
                description: `Created: ${unixToDateString(credential.creationDateUnix)}`,
...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            args: {
                name: "path",
                description: "Path to the secret (dl://<title>/<field> or dl://<id>/<field>)"
            }
        },
        {
            name: "exec",
        ...
        },
        {
            ...
            args: {
                name: "filters",
                description: "Filter notes based on any parameter using <param>=<value>; if <param> is not specified in the filter, will default to title only"
            }
        },
        {
            name: ["accounts", "a"],
