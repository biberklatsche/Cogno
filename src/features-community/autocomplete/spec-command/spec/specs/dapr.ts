    ...
    subcommands: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    args: { name: "max-request-body-size" }
                },
                {
                    name: "--memory-limit",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    args: { name: "dapr-internal-grpc-port" }
                },
                {
