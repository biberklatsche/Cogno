    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--permission",
                    description: 'Cloud IAM permission to check, e.g. "resourcemanager.projects.get"',
                    args: {
                        name: "PERMISSION",
                        description: "String"
                    }
                },
                {
                    ...
                    description: "Email address that identifies the member to check. Only Google Accounts and\nservice accounts are supported",
                    args: {
            ...
            args: {
                name: "RESOURCE",
                description: "Full resource name that access is checked against.\nSee: https://cloud.google.com/iam/docs/resource-names"
            }
        }
    ],
    options: [
