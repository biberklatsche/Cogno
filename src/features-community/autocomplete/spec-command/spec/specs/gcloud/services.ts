    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--force",
                    description: "If specified, the disable call will proceed even if there are enabled services which depend on the service to be disabled. Forcing the call means that the services which depend on the service to be disabled will also be disabled"
                },
                {
                    name: "--format",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--available",
                    description: "Return the services available to the project to enable. This list will include any services that the project has already enabled"
                },
                {
                    name: "--billing-project",
                    description: "The Google Cloud Platform project that will be charged quota for operations performed in gcloud. If you need to operate on one project, but need quota against a different project, you can use this flag to specify the billing project. If both `billing/quota_project` and `--billing-project` are specified, `--billing-project` takes precedence. Run `$ gcloud config set --help` to see more information about `billing/quota_project`",
                ...
                {
                    name: "--enabled",
                    description: "(DEFAULT) Return the services which the project has enabled"
                },
                {
                    name: "--filter",
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--full",
                            description: "(DEPRECATED) This flag is deprecated.\n+\nThis flag is deprecated",
                            args: {
                                name: "FULL",
                                description: "Int"
                            }
                ...
                {
                    name: "wait",
                    description: "Waits for an operation to complete for a given operation name",
                    options: [
                        {
                            name: "--account",
                            description: "Google Cloud Platform user account to use for invocation. Overrides the default *core/account* property value for this command invocation",
        ...
        },
        {
            ...
            subcommands: [
                {
                    name: "connect",
                    description: "Connect to a service via VPC peering for a project network",
                    options: [
                        {
                            name: "--account",
                            description: "Google Cloud Platform user account to use for invocation. Overrides the default *core/account* property value for this command invocation",
                        ...
                        {
                            name: "--network",
                            description: "The network in the current project to be peered with the service",
                            args: {
                                name: "NETWORK",
                                description: "String"
                            }
                ...
                {
                    name: "list",
                    description: "List connections to a service via VPC peering for a project network",
                    options: [
                        {
                            name: "--account",
                            description: "Google Cloud Platform user account to use for invocation. Overrides the default *core/account* property value for this command invocation",
                        ...
                        {
                            name: "--network",
                            description: "The network in the current project to list connections with the service",
                            args: {
                                name: "NETWORK",
                                description: "String"
                            }
                ...
                {
                    name: "update",
                    description: "Update a private service connection to a service for a project network",
                    options: [
                        {
                            name: "--account",
                            description: "Google Cloud Platform user account to use for invocation. Overrides the default *core/account* property value for this command invocation",
                        ...
                        {
                            name: "--force",
                            description: "If specified, the update call will proceed even if the update can be destructive"
                        },
                        {
                            name: "--format",
                            description: "Set the format for printing command output resources. The default is a\ncommand-specific human-friendly output format. The supported formats\nare: `config`, `csv`, `default`, `diff`, `disable`, `flattened`, `get`, `json`, `list`, `multi`, `none`, `object`, `table`, `text`, `value`, `yaml`. For more details run $ gcloud topic formats",
