            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--location",
                            description: "(DEPRECATED) Location of the Cloud Filestore instance.\n+\nThe `--location` flag is deprecated. Use `--zone`",
                            args: {
                                name: "LOCATION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--tier",
                            description: "The service tier for the Cloud Filestore instance. _TIER_ must be one of:\n+\n*premium*::: Premium Filestore instance.\n*standard*::: Standard Filestore instance.\n:::\n+",
                            args: {
                                name: "TIER",
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--zone",
                            description: "The zone of the operation",
                            args: {
                                name: "ZONE",
                                description: "String"
                            }
