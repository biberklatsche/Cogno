    ...
    subcommands: [
        {
            ...
            args: {
                name: "MOUNT_DIR",
                description: "Local directory onto which the Cloud Shell home directory should be\nmounted"
            }
        },
        {
            name: "scp",
            ...
            options: [
                ...
                {
                    name: "--scp-flag",
                    description: "Extra flag to be sent to scp. This flag may be repeated",
                    args: {
                        name: "SCP_FLAG",
                        description: "String"
                    }
