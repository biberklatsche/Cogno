...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        {
            name: "locations",
            description: "Query Cloud Game Services Locations",
            subcommands: [
                {
                    name: "describe",
        ...
        {
            name: "operations",
            description: "Deploy and manage Cloud Game Services Operations",
            subcommands: [
                {
                    name: "describe",
        ...
        {
            name: "servers",
            description: "Managed Cloud Game Servers",
            subcommands: [
                {
                    name: "clusters",
                    description: "Deploy and manage Cloud Game Server Clusters",
                    subcommands: [
                        {
                            name: "create",
                            ...
                            options: [
                                ...
                                {
                                    name: "--description",
                                    description: "Game server cluster description",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--dry-run",
                                    description: "Validate the creation, but do not execute it"
                                },
                                {
                                    name: "--flags-file",
                                    description: "A YAML or JSON file that specifies a *--flag*:*value* dictionary.\nUseful for specifying complex flag values with special characters\nthat work with any command interpreter. Additionally, each\n*--flags-file* arg is replaced by its constituent flags. See\n$ gcloud topic flags-file for more information",
                                ...
                                {
                                    name: "--namespace",
                                    description: "Namespace for Kubernetes API server endpoint",
                                    args: {
                                        name: "NAMESPACE",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--preview-time",
                                    description: "This attribute is only relevant for preview (--dry-run). It is used to validate\nthe state for a future time",
                                    args: {
                                        name: "PREVIEW_TIME",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--realm",
                                    description: "Cloud Game Servers Realm",
                                    args: {
                                        name: "REALM",
                                        description: "String"
                                    }
                            ...
                            args: {
                                name: "CLUSTER",
                                description: "ID of the game server cluster or fully qualified identifier for the game server cluster"
                            }
                        },
                        {
                            name: "delete",
                            ...
                            options: [
                                ...
                                {
                                    name: "--dry-run",
                                    description: "Validate the operation, but do not execute it"
                                },
                                {
                                    name: "--flags-file",
                                    description: "A YAML or JSON file that specifies a *--flag*:*value* dictionary.\nUseful for specifying complex flag values with special characters\nthat work with any command interpreter. Additionally, each\n*--flags-file* arg is replaced by its constituent flags. See\n$ gcloud topic flags-file for more information",
                                ...
                                {
                                    name: "--preview-time",
                                    description: "This attribute is only relevant for preview (--dry-run). It is used to validate the state for a future time",
                                    args: {
                                        name: "PREVIEW_TIME",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--realm",
                                    description: "Cloud Game Server Realm",
                                    args: {
                                        name: "REALM",
                                        description: "String"
                                    }
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--realm",
                                    description: "ID of the realm or fully qualified identifier for the realm",
                                    args: {
                                        name: "REALM",
                                        description: "String"
                                    }
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--description",
                                    description: "Description for the game server cluster",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--dry-run",
                                    description: "Validate the changes, but do not execute it"
                                },
                                {
                                    name: "--flags-file",
                                    description: "A YAML or JSON file that specifies a *--flag*:*value* dictionary.\nUseful for specifying complex flag values with special characters\nthat work with any command interpreter. Additionally, each\n*--flags-file* arg is replaced by its constituent flags. See\n$ gcloud topic flags-file for more information",
                ...
                {
                    name: "configs",
                    description: "Deploy and manage Cloud Game Server Configs",
                    subcommands: [
                        {
                            name: "create",
                            ...
                            options: [
                                ...
                                {
                                    name: "--deployment",
                                    description: "Cloud Game Servers Deployment",
                                    args: {
                                        name: "DEPLOYMENT",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--description",
                                    description: "Game server config description",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                            ...
                            args: {
                                name: "CONFIG",
                                description: "ID of the game server config or fully qualified identifier for the game server config"
                            }
                        },
                        {
                            name: "delete",
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--deployment",
                                    description: "ID of the deployment or fully qualified identifier for the deployment",
                                    args: {
                                        name: "DEPLOYMENT",
                                        description: "String"
                                    }
                ...
                {
                    name: "deployments",
                    description: "Deploy and manage Cloud Game Server Deployments",
                    subcommands: [
                        {
                            name: "create",
                            ...
                            options: [
                                ...
                                {
                                    name: "--description",
                                    description: "Game server deployment description",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--description",
                                    description: "Description for the game server deployment",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--dry-run",
                                    description: "Validate the rollout changes, but do not execute it"
                                },
                                {
                                    name: "--flags-file",
                                    description: "A YAML or JSON file that specifies a *--flag*:*value* dictionary.\nUseful for specifying complex flag values with special characters\nthat work with any command interpreter. Additionally, each\n*--flags-file* arg is replaced by its constituent flags. See\n$ gcloud topic flags-file for more information",
                ...
                {
                    name: "realms",
                    description: "Deploy and manage Cloud Game Server Realms",
                    subcommands: [
                        {
                            name: "create",
                            ...
                            options: [
                                ...
                                {
                                    name: "--description",
                                    description: "Game server realm description",
                                    args: {
                                        name: "DESCRIPTION",
                                        description: "String"
                                    }
                                ...
                                {
                                    name: "--time-zone",
                                    description: "Time zone where all realm-specific policies are evaluated. The value of this field must be\nfrom the IANA time zone database: https://www.iana.org/time-zones",
                                    args: {
                                        name: "TIME_ZONE",
                                        description: "String"
                                    }
