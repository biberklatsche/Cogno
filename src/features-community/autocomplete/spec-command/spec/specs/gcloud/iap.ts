      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              name: "--resource-type",
              description:
                "Resource type of the IAP resource. _RESOURCE_TYPE_ must be one of: *app-engine*, *iap_web*, *compute*, *organization*, *folder*",
              args: {
                name: "RESOURCE_TYPE",
                description: "String",
                suggestions: [
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              name: "--resource-type",
              description:
                "Resource type of the IAP IAM resource. _RESOURCE_TYPE_ must be one of: *app-engine*, *backend-services*",
              args: {
                name: "RESOURCE_TYPE",
                description: "String",
