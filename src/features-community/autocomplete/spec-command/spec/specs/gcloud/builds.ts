    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          name: "--gcs-log-dir",
          description:
            "A directory in Google Cloud Storage to hold build logs. If this field is not set, ```gs://[PROJECT_NUMBER].cloudbuild-logs.googleusercontent.com/``` will be created and used",
          args: {
            name: "GCS_LOG_DIR",
            description: "String",
            suggestions: [],
        ...
        },
        {
          name: "--machine-type",
          description:
            "Machine type used to run the build. _MACHINE_TYPE_ must be one of: *n1-highcpu-32*, *n1-highcpu-8*",
          args: {
            name: "MACHINE_TYPE",
            description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
            suggestions: ["n1-highcpu-32", "n1-highcpu-8"],
          },
        },
        {
          name: "--no-cache",
        ...
        },
        {
          name: "--worker-pool",
          description:
            "Specify a worker pool for the build to run in. Format: projects/{project}/locations/{region}/workerPools/{workerPool}. This field is restricted to custom workers beta users",
          args: {
            name: "WORKER_POOL",
            description: "String",
            suggestions: [],
