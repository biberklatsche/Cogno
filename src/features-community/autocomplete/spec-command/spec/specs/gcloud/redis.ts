          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "VERSION",
                description: "String",
                suggestions: ["redis_3_2", "redis_4_0", "redis_5_0"],
              },
            },
            {
              name: "--region",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              name: "--redis-version",
              description:
                "Target version of Redis software. You can only upgrade to the next highest version. For example, you must upgrade an instance from redis_3_2 to redis_4_0 before you can upgrade the instance to redis_5_0. _VERSION_ must be one of:\n+\n*redis_4_0*::: Redis 4.0 compatibility\n*redis_5_0*::: Redis 5.0 compatibility\n:::\n+",
              args: {
                name: "VERSION",
                description: "String",
                suggestions: ["redis_4_0", "redis_5_0"],
              },
              priority: 100,
            },
            {
