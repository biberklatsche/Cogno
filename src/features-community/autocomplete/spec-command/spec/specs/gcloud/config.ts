    ...
    subcommands: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Force a refresh of the credentials even if they have not yet expired. By default, credentials will only refreshed when necessary"
                },
                {
                    name: "--format",
                ...
                {
                    name: "--min-expiry",
                    description: "If given, refresh the credentials if they are within MIN_EXPIRY from expiration",
                    args: {
                        name: "MIN_EXPIRY",
            ...
            subcommands: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--activate",
                            description: "If true, activate this configuration upon create. Enabled by default, use *--no-activate* to disable"
                        },
                        {
                            name: "--billing-project",
                            description: "The Google Cloud Platform project that will be charged quota for operations performed in gcloud. If you need to operate on one project, but need quota against a different project, you can use this flag to specify the billing project. If both `billing/quota_project` and `--billing-project` are specified, `--billing-project` takes precedence. Run `$ gcloud config set --help` to see more information about `billing/quota_project`",
                ...
                },
                {
                    ...
                    args: {
                        ...
                        description: "Name of the configuration to delete. Cannot be currently active configuration"
                    }
                },
                {
                    name: "describe",
        ...
        },
        {
            ...
            args: {
                ...
                description: "The property to be fetched. Note that `SECTION/` is optional while referring to properties in the core section"
            }
        },
        {
            name: "list",
            ...
            options: [
                ...
                {
                    name: "--all",
                    description: "List all set and unset properties that match the arguments"
                },
                {
                    name: "--billing-project",
                    description: "The Google Cloud Platform project that will be charged quota for operations performed in gcloud. If you need to operate on one project, but need quota against a different project, you can use this flag to specify the billing project. If both `billing/quota_project` and `--billing-project` are specified, `--billing-project` takes precedence. Run `$ gcloud config set --help` to see more information about `billing/quota_project`",
            ...
            args: {
                name: "SECTION/PROPERTY",
                description: "Property to be listed. Note that SECTION/ is optional while referring to properties in the core section"
            }
        },
        {
            name: "set",
            ...
            options: [
                ...
                {
                    name: "--installation",
                    description: "If set, the property is updated for the entire Cloud SDK installation.\nOtherwise, by default, the property is updated only in the currently\nactive configuration"
                },
                {
                    name: "--log-http",
                    description: "Log all HTTP server requests and responses to stderr. Overrides the default *core/log_http* property value for this command invocation"
        ...
        },
        {
            ...
            args: {
                name: "SECTION/PROPERTY",
                description: "The property to be unset. Note that SECTION/ is optional while referring to properties in the core section"
            }
        }
    ],
    options: [
