      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              name: "--start-time",
              description:
                "Return only log entries which timestamps are not earlier than the specified time. If *--start-time* is specified, the command returns *--limit* earliest log entries which appeared after *--start-time*. See $ gcloud topic datetimes for information on time formats",
              args: {
                name: "START_TIME",
                description: "Googlecloudsdk.calliope.arg_parsers:Parse",
                suggestions: [],
