    ...
    subcommands: [
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--region",
                            description: "The region to create the Google Cloud Firestore in Datastore Mode database within. Use `gcloud app regions list` to list available regions",
                            args: {
                                name: "REGION",
                                description: "String"
                            }
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--operation-labels",
                    description: "A string:string map of custom labels to associate with this operation.\nFor example:\n+\n  $ {command} --operation-labels=comment='customer orders','sales rep'=pending",
                    args: {
