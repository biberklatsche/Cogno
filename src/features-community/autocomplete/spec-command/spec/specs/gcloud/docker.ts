...
const completionSpec: CommandSpec = {
    ...
    options: [
        ...
        {
            name: "--authorize-only",
            description: "Configure Docker authorization only; do not launch the Docker command-line"
        },
        {
        ...
        {
            name: "--docker-host",
            description: "URL to connect to Docker Daemon. Format: tcp://host:port or unix:///path/to/socket",
            args: {
                name: "DOCKER_HOST",
                description: "String"
            }
        ...
        {
            name: "--server",
            description: "Address of the Google Cloud Registry",
            args: {
                name: "SERVER",
                description: "List"
            }
