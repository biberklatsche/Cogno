            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            description: "IP address range for the pods in this cluster in CIDR notation\n(e.g. 10.0.0.0/14).\n+\nCannot be specified unless '--enable-ip-alias' is also specified",
                            args: {
                        ...
                        {
                            name: "--disk-size",
                            description: "The disk size for each VM node in the environment. The minimum size is 20GB, and the maximum is 64TB. Specified value must be an integer multiple of gigabytes. Cannot be updated after the environment has been created. If units are not provided, defaults to GB",
                            args: {
                                name: "DISK_SIZE",
                        ...
                        {
                            name: "--location",
                            description: "Compute Engine region in which to create the environment",
                            args: {
                                name: "LOCATION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--machine-type",
                            description: "The Compute Engine machine type (https://cloud.google.com/compute/docs/machine-types) to use for nodes. For example `--machine-type=n1-standard-1`",
                            args: {
                                name: "MACHINE_TYPE",
                                description: "String"
                            }
                        },
                        {
                            ...
                            description: "IPv4 CIDR range to use for the cluste master network. This should have a\nsize of the netmask between 23 and 28.\n+\nCannot be specified unless '--enable-private-environment' is also\nspecified",
                            args: {
                        ...
                        {
                            name: "--network",
                            description: "The Compute Engine Network to which the environment will be connected. If a 'Custom Subnet Network' is provided, `--subnetwork` must be specified as well",
                            args: {
                                name: "NETWORK",
                                description: "String"
                            }
                        ...
                        {
                            name: "--node-count",
                            description: "The number of nodes to create to run the environment",
                            args: {
                                name: "NODE_COUNT",
                                description: "String"
                            }
                        ...
                        {
                            name: "--oauth-scopes",
                            description: "The set of Google API scopes to be made available on all of the node VMs. Defaults to ['https://www.googleapis.com/auth/cloud-platform']. Cannot be updated",
                            args: {
                                name: "SCOPE",
                                description: "List"
                            }
                        ...
                        {
                            name: "--python-version",
                            description: "The Python version to be used within the created environment. Supplied value should represent the desired major Python version. Cannot be updated. _PYTHON_VERSION_ must be one of:\n+\n*2*::: Created environment will use Python 2\n*3*::: Created environment will use Python 3\n:::\n+",
                            args: {
                                name: "PYTHON_VERSION",
                                description: "String"
                            }
                        ...
                        },
                        {
                            ...
                            description: 'The Google Cloud Platform service account to be used by the node VMs. If a service account is not specified, the "default" Compute Engine service account for the project is used. Cannot be updated',
                            args: {
                        ...
                        },
                        {
                            ...
                            description: "Secondary range to be used for services (e.g. ClusterIPs). NAME must be the\nname of an existing secondary range in the cluster subnetwork.\n+\nCannot be specified unless '--enable-ip-alias' is also specified",
                            args: {
                        ...
                        {
                            name: "--subnetwork",
                            description: "The Compute Engine subnetwork (https://cloud.google.com/compute/docs/subnetworks) to which the environment will be connected",
                            args: {
                                name: "SUBNETWORK",
                                description: "String"
                            }
                        ...
                        {
                            name: "--tags",
                            description: "The set of instance tags applied to all node VMs. Tags are used to identify valid sources or targets for network firewalls. Each tag within the list must comply with RFC 1035. Cannot be updated",
                            args: {
                                name: "TAG",
                                description: "List"
                            }
                        ...
                        },
                        {
                            ...
                            description: "IPv4 CIDR range to use for the Airflow web server network. This should have\na size of the netmask between 24 and 29.\n+\nCannot be specified unless '--enable-private-environment' is also\nspecified",
                            args: {
                        ...
                        {
                            name: "--zone",
                            description: "The Compute Engine zone in which the environment will be created. For example `--zone=us-central1-a`",
                            args: {
                                name: "ZONE",
                                description: "String"
                            }
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--location",
                            description: "Compute Engine region in which to create the environments",
                            args: {
                                name: "LOCATION",
                                description: "String"
                            }
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--locations",
                            description: "IDs of the locations or fully qualified identifiers for the locations",
                            args: {
                                name: "LOCATIONS",
                                description: "List"
                            }
                            ...
                            subcommands: [
                                ...
                                },
                                {
                                    ...
                                    options: [
                                        ...
                                        {
                                            name: "--destination",
                                            description: "The path to an existing local directory or a Cloud Storage\nbucket/directory into which to export files",
                                            args: {
                                                name: "DESTINATION",
                                                description: "String"
                                            }
                                        ...
                                        {
                                            name: "--source",
                                            description: "An optional relative path to a file or directory to be exported from the\ndags/ subdirectory in the environment's Cloud Storage bucket",
                                            args: {
                                                name: "SOURCE",
                                                description: "String"
                                            }
                            ...
                            subcommands: [
                                ...
                                },
                                {
                                    ...
                                    options: [
                                        ...
                                        {
                                            name: "--destination",
                                            description: "An optional subdirectory under the data/ directory in the environment's\nCloud Storage bucket into which to import files. May contain forward\nslashes to delimit multiple levels of subdirectory nesting, but should not\ncontain leading or trailing slashes. If the DESTINATION does not exist, it\nwill be created",
                                            args: {
                                                name: "DESTINATION",
                                                description: "String"
                                            }
                            ...
                            subcommands: [
                                ...
                                },
                                {
                                    ...
                                    options: [
                                        ...
                                        {
                                            name: "--destination",
                                            description: "An optional subdirectory under the plugins/ directory in the environment's\nCloud Storage bucket into which to import files. May contain forward\nslashes to delimit multiple levels of subdirectory nesting, but should not\ncontain leading or trailing slashes. If the DESTINATION does not exist, it\nwill be created",
                                            args: {
                                                name: "DESTINATION",
                                                description: "String"
                                            }
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--node-count",
                            description: "The new number of nodes running the environment. Must be >= 3",
                            args: {
                                name: "NODE_COUNT",
                                description: "Googlecloudsdk.calliope.arg_parsers:Parse"
                            }
                        ...
                        },
                        {
                            ...
                            description: "A list of environment variables to remove.\n+\nEnvironment variables that have system-provided defaults cannot be unset\nwith the `--remove-env-variables` or `--clear-env-variables` flags; only\nthe user-supplied overrides will be removed",
                            args: {
                                name: "NAME",
                                description: "List"
                            }
                        ...
                        },
                        {
                            ...
                            description: "A list of PyPI package names to remove.\n+\nPyPI packages that are required by the environment's core software\ncannot be uninstalled with the `--remove-pypi-packages` or\n`--clear-pypi-packages` flags",
                            args: {
                                name: "PACKAGE",
                                description: "List"
                            }
