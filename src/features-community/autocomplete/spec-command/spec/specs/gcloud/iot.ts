            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  name: "--config-data",
                  description:
                    "The data for this configuration, as a string. For any values that contain special characters (in the context of your shell), use the `--config-file` flag instead",
                  args: {
                    name: "CONFIG_DATA",
                    description: "String",
                    suggestions: [],
          ...
          options: [
            ...
            },
            {
              ...
              args: {
                name: "DEVICE_TYPE",
                description: "Googlecloudsdk.calliope.base:_ChoiceValueType",
                suggestions: ["gateway", "non-gateway"],
              },
            },
            {
              name: "--flags-file",
            ...
            },
            {
              ...
              args: {
                ...
                suggestions: ["debug", "error", "info", "none"],
              },
            },
            {
              name: "--metadata",
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  name: "--type",
                  description:
                    "The type of the key. _TYPE_ must be one of:\n+\n*es256*::: Deprecated nmame for `es256-pem`\n*es256-pem*:::         Public key for the ECDSA algorithm using P-256 and\n        SHA-256, encoded in base64, and wrapped by\n        `-----BEGIN PUBLIC KEY-----` and\n        `-----END PUBLIC KEY-----`. This can be used to verify JWT\n        tokens with the `ES256` algorithm\n        ([RFC7518](https://www.ietf.org/rfc/rfc7518.txt)). This\n        curve is defined in [OpenSSL](https://www.openssl.org/) as\n        the `prime256v1` curve.\n*es256-x509-pem*:::         As ES256_PEM, but wrapped in an X.509v3 certificate\n        ([RFC5280](https://www.ietf.org/rfc/rfc5280.txt)),\n        encoded in base64, and wrapped by\n        `-----BEGIN CERTIFICATE-----` and\n        `-----END CERTIFICATE-----`.\n*rs256*::: Deprecated name for `rsa-x509-pem`\n*rsa-pem*:::         An RSA public key encoded in base64, and wrapped by\n        `-----BEGIN PUBLIC KEY-----` and `-----END PUBLIC KEY-----`.\n        This can be used to verify `RS256` signatures in JWT tokens\n        ([RFC7518](https://www.ietf.org/rfc/rfc7518.txt)).\n*rsa-x509-pem*:::         As RSA_PEM, but wrapped in an X.509v3 certificate\n        ([RFC5280](https://www.ietf.org/rfc/rfc5280.txt)),\n        encoded in base64, and wrapped by\n        `-----BEGIN CERTIFICATE-----` and\n        `-----END CERTIFICATE-----`.\n:::\n+",
                  args: {
                    name: "TYPE",
                    description:
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              description:
                "Whether to allow device connections to the HTTP bridge. Enabled by default, use *--no-enable-http-config* to disable",
            },
            {
              name: "--enable-mqtt-config",
              description:
                "Whether to allow MQTT connections to this device registry. Enabled by default, use *--no-enable-mqtt-config* to disable",
            },
            {
            ...
            },
            {
              ...
              options: [
                ...
                },
                {
                  name: "--path",
                  description:
                    "Path to a file containing an X.509v3 certificate ([RFC5280](https://www.ietf.org/rfc/rfc5280.txt)), encoded in base64, and wrapped by `-----BEGIN CERTIFICATE-----` and `-----END CERTIFICATE-----`",
                  args: {
                    name: "PATH",
                    description: "String",
                    suggestions: [],
