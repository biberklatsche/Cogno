            ...
            subcommands: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            description: 'GroupAssetsResult\'s "state_change" attribute is updated to indicate whether the asset was added, removed, or remained present during the compare_duration period of time that precedes the read_time.\nExample duration: "100000s"',
                            args: {
                        ...
                        {
                            name: "--page-token",
                            description: "Value returned by the last 'GroupAssetsResponse'; indicates\nthat this is a continuation of a prior 'GroupAssets' call, and that the\nsystem should return the next page of data",
                            args: {
                                name: "PAGE_TOKEN",
                                description: "String"
                            }
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--compare-duration",
                            description: 'ListAssetResult\'s "state" attribute is updated to indicate whether the asset was added, removed, or remained present during the compare_duration period of time that precedes the read_time.\nExample duration: "100000s"',
                            args: {
                                name: "COMPARE_DURATION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--field-mask",
                            description: 'Field mask to specify the Asset fields to be listed in the response. An empty field mask will list all fields.\nExample field mask: "asset.security_center_properties.resource_type,asset.security_center_properties.resource_parent"',
                            args: {
                                name: "FIELD_MASK",
                                description: "String"
                            }
                        ...
                        {
                            name: "--read-time",
                            description: 'Time used as a reference point when filtering assets. Default: NOW\nExample read time: "2019-02-28T07:00:06.861Z"',
                            args: {
                                name: "READ_TIME",
                                description: "String"
                            }
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--organization",
                            description: "(Optional) If the full resource name isn't provided e.g. organizations/123, then provide the\norganization id which is the suffix of the organization. Example: organizations/123, the id is\n123",
                            args: {
                                name: "ORGANIZATION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--read-time",
                            description: 'Time used as a reference point when filtering. Absence of this field will default to the API\'s\nversion of NOW. For example --read-time "2019-02-28T07:00:00Z"',
                            args: {
                                name: "READ_TIME",
                                description: "String"
                            }
                    ...
                    args: {
                        name: "ASSET",
                        description: "ID of the asset or fully qualified identifier for the asset"
                    }
                },
                {
                    name: "run-discovery",
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--security-marks",
                            description: 'SecurityMarks resource to be passed as the request body. It\'s a key=value pair separated\nby comma (,). For example: --security-marks="key1=val1,key2=val2"',
                            args: {
                                name: "SECURITY_MARKS",
                                description: "Dict"
                            }
                        ...
                        {
                            name: "--start-time",
                            description: "Time at which the updated SecurityMarks take effect. For example 2019-02-28T07:00:00Z",
                            args: {
                                name: "START_TIME",
                                description: "String"
                            }
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--category",
                            description: "Taxonomy group within findings from a given source. Example: XSS_FLASH_INJECTION",
                            args: {
                                name: "CATEGORY",
                                description: "String"
                            }
                        ...
                        {
                            name: "--resource-name",
                            description: "Full resource name of the Google Cloud Platform resource this finding is for",
                            args: {
                                name: "RESOURCE_NAME",
                                description: "String"
                            }
                        ...
                        {
                            name: "--state",
                            description: "State is one of: [ACTIVE, INACTIVE]. _STATE_ must be one of: *active*, *inactive*, *state-unspecified*",
                            args: {
                                name: "STATE",
                    ...
                    args: {
                        name: "FINDING",
                        description: "ID of the finding or fully qualified identifier for the finding"
                    }
                },
                {
                    name: "group",
                    ...
                    options: [
                        ...
                        {
                            name: "--group-by",
                            description: "Expression that defines what findings fields to use for grouping (including 'state').\nString value should follow SQL syntax: comma separated list  of fields.\nFor example: \"parent,resource_name\".  The following fields are supported:\n* resource_name\n* category\n* state\n* parent",
                            args: {
                                name: "GROUP_BY",
                                description: "String"
                            }
                        ...
                        {
                            name: "--page-size",
                            description: "Maximum number of results to return in a single response. Default is 10, minimum is 1,\nmaximum is 1000",
                            args: {
                                name: "PAGE_SIZE",
                                description: "String"
                            }
                        ...
                        {
                            name: "--read-time",
                            description: "Time used as a reference point when filtering findings. The filter is limited\nto findings existing at the supplied time and their values are those at that\nspecific time. For example. 2019-02-28T07:00:00Z. Absence of this field will\ndefault to the API's version of NOW",
                            args: {
                                name: "READ_TIME",
                                description: "String"
                            }
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--description",
                            description: "The text that will be used to describe a notification configuration",
                            args: {
                                name: "DESCRIPTION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--organization",
                            description: 'The organization where the notification config resides. Formatted as "organizations/123" or just "123". Required if notificationConfigId does not contain organization information',
                            args: {
                                name: "ORGANIZATION",
                                description: "String"
                            }
                        ...
                        {
                            name: "--pubsub-topic",
                            description: 'The Pub/Sub topic which will receive notifications. Its format is\n"projects/[project_id]/topics/[topic]"',
                            args: {
                                name: "PUBSUB_TOPIC",
                                description: "String"
                            }
                    ...
                    args: {
                        ...
                        description: 'The ID of the notification config. Formatted as "organizations/123/notificationConfigs/456" or just "456"'
                    }
                },
                {
                    name: "delete",
                ...
                },
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--filter",
                            description: "The filter string which will applied to events of findings of a\nnotification configuration",
                            args: {
                                name: "FILTER",
                                description: "String"
                            }
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--source",
                            description: "Cloud SCC specific source. It's derived from the the source's relative resource name.\nSee: https://cloud.google.com/apis/design/resource_names#relative_resource_name.\nFor Example: For the given source name: \"organizations/123/sources/456\", 456 represents\nsource id",
                            args: {
                                name: "SOURCE",
                                description: "String"
                            }
