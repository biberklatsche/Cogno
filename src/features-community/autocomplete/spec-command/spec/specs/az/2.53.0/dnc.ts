  ...
  subcommands: [
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "purpose", suggestions: ["prod", "test"] },
            },
            {
              name: "--tags",
              description:
        ...
        {
          name: "delete",
          description: "Delete the DNC controller",
          options: [
            {
              name: "--ids",
              description:
        ...
        {
          name: "show",
          description: "Get details about the specified dnc controller",
          options: [
            {
              name: "--ids",
              description:
    ...
    },
    {
      ...
      subcommands: [
        {
          name: "create",
          description: "Create delegated subnet resource",
          options: [
            {
              name: ["--resource-name", "--name", "-n"],
              description:
            ...
            },
            {
              ...
              args: { name: "allocation-block-prefix-size" },
            },
            {
              name: "--id",
      ...
      subcommands: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              args: { name: "api-server-endpoint" },
            },
            {
              name: "--cluster-root-ca",
              description:
                "RootCA certificate of kubernetes cluster base64 encoded",
              args: { name: "cluster-root-ca" },
            },
            {
              name: "--id",
              description: "Controller arm resource id",
            ...
            },
            {
              ...
              args: { name: "kind", suggestions: ["Kubernetes"] },
            },
            {
              name: ["--location", "-l"],
              description: "Location of the resource",
            ...
            },
            {
              ...
              args: { name: "type", suggestions: ["None", "SystemAssigned"] },
            },
          ],
        },
        {
          name: "delete",
          description: "Delete the Orchestrator Instance",
          options: [
            {
              name: "--force-delete",
              description: "Force delete resource",
        ...
        {
          name: "show",
          description: "Get details about the orchestrator instance",
          options: [
            {
              name: "--ids",
              description:
