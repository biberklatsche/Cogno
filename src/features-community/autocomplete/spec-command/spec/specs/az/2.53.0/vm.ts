        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    args: { name: "disk-controller-type" }
                },
                {
                    name: "--edge-zone",
                ...
                },
                {
                    ...
                    args: { name: "enable-hotpatching" }
                },
                {
                    name: "--enable-secure-boot",
                    description: "Enable secure boot",
                    args: { name: "enable-secure-boot" }
                },
                {
                    name: "--enable-vtpm",
                    description: "Enable vTPM",
                    args: { name: "enable-vtpm" }
                },
                {
