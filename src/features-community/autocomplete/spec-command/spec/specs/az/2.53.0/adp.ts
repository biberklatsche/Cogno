                    ...
                    subcommands: [
                        {
                            ...
                            options: [
                                ...
                                {
                                    name: "--locations",
                                    description: 'Gets or sets the collection of locations where Data Pool resources should be created Support shorthand-syntax, json-file and yaml-file. Try "??" to show more',
                                    args: { name: "locations" }
                                },
                                {
                                    name: "--no-wait",
            ...
            subcommands: [
                {
                    ...
                    options: [
                        ...
                        {
                            name: "--encryption",
                            description: 'The encryption configuration. Support shorthand-syntax, json-file and yaml-file. Try "??" to show more',
                        ...
                        {
                            name: "--storage-sku",
                            description: 'The Storage SKU. If not provided, defaults to Standard_ZRS. Support shorthand-syntax, json-file and yaml-file. Try "??" to show more',
