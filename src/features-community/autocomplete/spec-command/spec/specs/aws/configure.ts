...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        {
            name: "add-model",
            description: "Adds a service JSON model to the appropriate location in ~/.aws/models. Once the model gets added, CLI commands and Boto3 clients will be immediately available for the service JSON model provided",
            options: [
                {
                    name: "--service-model",
                ...
                {
                    name: "--service-name",
                    description: "Overrides the default name used by the service JSON model to generate CLI service commands and Boto3 clients",
                    args: {
                        name: "string"
                    }
                }
