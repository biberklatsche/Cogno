...
const listCustomSIDGenerator = async (tokens: string[], executeShellCommand: ExecuteCommandFunction, command: string, options: string[]): Promise<Suggestion[]> => {
    try {
        let args = ["lambda", command];
        for (let i = 0; i < options.length; i++) {
            const option = options[i];
...
const generators: Record<string, Generator> = {
    ...
    listLayerVersionNumber: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "list-layer-versions", ["--layer-name"], "LayerVersions", "Version");
        },
        cache: {
            ttl: ttl,
        },
    ...
    getLayerVersionPolicyRevision: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "get-layer-version-policy", ["--layer-name", "--version-number"], "RevisionId");
        },
        cache: {
            ttl: ttl,
        },
    ...
    getFunctionPolicyRevisionId: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "get-policy", ["--function-name"], "RevisionId");
        },
        cache: {
            ttl: ttl,
        },
    ...
    getFunctionRevisionId: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "get-function", ["--function-name"], "Configuration", "RevisionId");
        },
        cache: {
            ttl: ttl,
        },
    ...
    listAliases: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "list-aliases", ["--function-name"], "Aliases", "Name");
        },
        cache: {
            ttl: ttl,
        },
    ...
    listLayerVersionSIDs: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomSIDGenerator(tokens, executeShellCommand, "get-layer-version-policy", ["--layer-name", "--version-number"]);
        },
        cache: {
            ttl: ttl,
        },
    ...
    listCodeSigningConfigs: {
        ...
        postProcess: function (out) {
            return postPrecessGenerator(out, "CodeSigningConfigs", "CodeSigningConfigArn");
        },
        cache: {
            ttl: ttl,
        },
    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--principal",
                    description: "The Amazon Web Services service, Amazon Web Services account, IAM user, or IAM role that invokes the function. If you specify a service, use SourceArn or SourceAccount to limit who can invoke the function through that service",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--source-account",
                    description: "For Amazon Web Services service, the ID of the Amazon Web Services account that owns the resource. Use this together with SourceArn to ensure that the specified account owns the resource. It is possible for an Amazon S3 bucket to be deleted by its owner and recreated by another account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--scaling-config",
                    description: "(Amazon SQS only) The scaling configuration for the event source. For more information, see Configuring maximum concurrency for Amazon SQS event sources",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--kms-key-arn",
                    description: "The ARN of the Key Management Service (KMS) customer managed key that Lambda uses to encrypt your function's filter criteria. By default, Lambda does not encrypt your filter criteria object. Specify this property to encrypt data using your own customer managed key",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--metrics-config",
                    description: "The metrics configuration for your event source. For more information, see Event source mapping metrics",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "(Amazon MSK and self-managed Apache Kafka only) The Provisioned Mode configuration for the event source. For more information, see Provisioned Mode",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--timeout",
                    description: "The amount of time (in seconds) that Lambda allows a function to run before stopping it. The default is 3 seconds. The maximum allowed value is 900 seconds. For more information, see Lambda execution environment",
                    args: {
                        name: "integer"
                    }
                },
                ...
                {
                    name: "--vpc-config",
                    description: "For network connectivity to Amazon Web Services resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can access resources and the internet only through that VPC. For more information, see Configuring a Lambda function to access resources in a VPC",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--zip-file",
                    description: "The path to the zip file of the code you are uploading. Specify --zip-file or --code, but not both. Example: fileb://code.zip",
                    args: {
                        name: "blob"
                    }
                },
        ...
        },
        {
            ...
            description: "Deletes a Lambda function. To delete a specific function version, use the Qualifier parameter. Otherwise, all versions and aliases are deleted. This doesn't require the user to have explicit permissions for DeleteAlias. To delete Lambda event source mappings that invoke a function, use DeleteEventSourceMapping. For Amazon Web Services services and resources that invoke your function directly, delete the trigger in the service where you originally configured it",
            options: [
                {
                    name: "--function-name",
                    description: "The name or ARN of the Lambda function or version.  Name formats     Function name \u2013 my-function (name-only), my-function:1 (with version).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            description: "Returns your function's recursive loop detection configuration",
            options: [
                {
                    name: "--function-name",
                    args: {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--qualifier",
                    description: "Specify a version of the function. This can be $LATEST or a published version number. If no value is specified, the configuration for the $LATEST version is returned",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--client-context",
                    description: "Up to 3,583 bytes of base64-encoded data about the invoking client to pass to the function in the context object. Lambda passes the ClientContext object to your function for synchronous invocations only",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--payload",
                    description: 'The JSON that you want to provide to your Lambda function as input. You can enter the JSON directly. For example, --payload \'{ "key": "value" }\'. You can also specify a file path. For example, --payload file://payload.json',
                    args: {
                        name: "blob"
                    }
                },
        ...
        {
            name: "invoke-async",
            description: "For asynchronous function invocation, use Invoke.  Invokes a function asynchronously.  If you do use the InvokeAsync action, note that it doesn't support the use of X-Ray active tracing. Trace ID is not propagated to the function, even if X-Ray active tracing is turned on",
            options: [
                {
                    name: "--function-name",
                    description: "The name or ARN of the Lambda function.  Name formats     Function name \u2013 my-function.    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
        ...
        },
        {
            ...
            options: [
                {
                    name: "--master-region",
                    description: "For Lambda@Edge functions, the Amazon Web Services Region of the master function. For example, us-east-1 filters the list of functions to include only Lambda@Edge functions replicated from a master function in US East (N. Virginia). If specified, you must set FunctionVersion to ALL",
                    args: {
                        name: "string"
                    }
                },
            ...
            options: [
                {
                    ...
                    description: "A runtime identifier. The following list includes deprecated runtimes. For more information, see Runtime use after deprecation. For a list of all currently supported runtimes, see Supported runtimes",
                    args: {
                        name: "string"
                    }
                },
        ...
        {
            name: "list-tags",
            description: "Returns a function, event source mapping, or code signing configuration's tags. You can also view function tags with GetFunction",
            options: [
                {
                    name: "--resource",
                    description: "The resource's Amazon Resource Name (ARN). Note: Lambda does not support adding tags to function aliases or versions",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A list of compatible function runtimes. Used for filtering with ListLayers and ListLayerVersions. The following list includes deprecated runtimes. For more information, see Runtime deprecation policy",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--license-info",
                    description: "The layer's software license. It can be any of the following:   An SPDX license identifier. For example, MIT.   The URL of a license hosted on the internet. For example, https://opensource.org/licenses/MIT.   The full text of the license",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--zip-file",
                    description: "The path to the zip file of the content you are uploading. Specify --zip-file or --content, but not both. Example: fileb://content.zip",
                    args: {
                        name: "blob"
                    }
                },
        ...
        },
        {
            ...
            description: "Revokes function-use permission from an Amazon Web Services service or another Amazon Web Services account. You can get the ID of the statement from the output of GetPolicy",
            options: [
                {
                    name: "--function-name",
                    description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
        ...
        {
            name: "tag-resource",
            description: "Adds tags to a function, event source mapping, or code signing configuration",
            options: [
                {
                    name: "--resource",
        ...
        {
            name: "untag-resource",
            description: "Removes tags from a function, event source mapping, or code signing configuration",
            options: [
                {
                    name: "--resource",
                    description: "The resource's Amazon Resource Name (ARN)",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ARN of the Key Management Service (KMS) customer managed key that's used to encrypt your function's .zip deployment package. If you don't provide a customer managed key, Lambda uses an Amazon Web Services managed key",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--image-config",
                    description: "Container image configuration values that override the values in the container image Docker file",
                    args: {
                        name: "structure"
                    }
                },
            ...
            subcommands: [
                {
                    ...
                    description: "Waits for the function's State to be Active. This waiter uses GetFunctionConfiguration API. This should be used after new function creation. It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                ...
                },
                {
                    ...
                    description: "Waits for the function's State to be Active. This waiter uses GetFunction API. This should be used after new function creation. It will poll every 1 seconds until a successful state has been reached. This will exit with a return code of 255 after 300 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                ...
                },
                {
                    ...
                    description: "Wait until 200 response is received when polling with ``get-function``. It will poll every 1 seconds until a successful state has been reached. This will exit with a return code of 255 after 20 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                ...
                },
                {
                    ...
                    description: "Waits for the function's LastUpdateStatus to be Successful. This waiter uses GetFunctionConfiguration API. This should be used after function updates. It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                ...
                },
                {
                    ...
                    description: "Waits for the function's LastUpdateStatus to be Successful. This waiter uses GetFunction API. This should be used after function updates. It will poll every 1 seconds until a successful state has been reached. This will exit with a return code of 255 after 300 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
                ...
                },
                {
                    ...
                    description: "Waits for the published version's State to be Active. This waiter uses GetFunctionConfiguration API. This should be used after new version is published. It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 312 failed checks",
                    options: [
                        {
                            name: "--function-name",
                            description: "The name or ARN of the Lambda function, version, or alias.  Name formats     Function name \u2013 my-function (name-only), my-function:v1 (with alias).    Function ARN \u2013 arn:aws:lambda:us-west-2:123456789012:function:my-function.    Partial ARN \u2013 123456789012:function:my-function.   You can append a version number or alias to any of the formats. The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length",
