    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--license-type",
                    description: "The type of license to associate with the workspace.  Amazon Managed Grafana workspaces no longer support Grafana Enterprise free trials",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies the version of Grafana to support in the new workspace. If not specified, defaults to the latest version (for example, 10.4). To get a list of supported versions, use the ListVersions operation",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The configuration settings for an Amazon VPC that contains data sources for your Grafana workspace to connect to.  Connecting to a private VPC is not yet available in the Asia Pacific (Seoul) Region (ap-northeast-2)",
                    args: {
                        name: "structure"
                    }
                },
                ...
                },
                {
                    ...
                    description: "A description for the workspace. This is used only to help you identify this workspace. Pattern: ^[\\\\p{L}\\\\p{Z}\\\\p{N}\\\\p{P}]{0,2048}$",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--key-role",
                    description: "Specifies the permission level of the key.  Valid values: ADMIN|EDITOR|VIEWER",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace within which to create the service account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "The token for the next set of service accounts to return. (You receive this token from a previous ListWorkspaceServiceAccountTokens operation.)",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "The token for the next set of service accounts to return. (You receive this token from a previous ListWorkspaceServiceAccounts operation.)",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--network-access-control",
                    description: "The configuration settings for network access to your workspace. When this is configured, only listed IP addresses and VPC endpoints will be able to access your workspace. Standard Grafana authentication and authorization will still be required. If this is not configured, or is removed, then all IP addresses and VPC endpoints will be allowed. Standard Grafana authentication and authorization will still be required",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--organization-role-name",
                    description: "The name of an IAM role that already exists to use to access resources through Organizations. This can only be used with a workspace that has the permissionType set to CUSTOMER_MANAGED",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Whether to remove the network access configuration from the workspace. Setting this to true and providing a networkAccessControl to set will return an error. If you remove this configuration by setting this to true, then all IP addresses and VPC endpoints will be allowed. Standard Grafana authentication and authorization will still be required"
                },
                {
                ...
                },
                {
                    ...
                    description: "Whether to remove the VPC configuration from the workspace. Setting this to true and providing a vpcConfiguration to set will return an error"
                },
                {
                ...
                {
                    name: "--workspace-role-arn",
                    description: "Specifies an IAM role that grants permissions to Amazon Web Services resources that the workspace accesses, such as data sources and notification channels. If this workspace has permissionType CUSTOMER_MANAGED, then this role is required",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--grafana-version",
                    description: "Specifies the version of Grafana to support in the workspace. If not specified, keeps the current version of the workspace. Can only be used to upgrade (for example, from 8.4 to 9.4), not downgrade (for example, from 9.4 to 8.4). To know what versions are available to upgrade to for a specific workspace, see the ListVersions operation",
                    args: {
                        name: "string"
                    }
                },
