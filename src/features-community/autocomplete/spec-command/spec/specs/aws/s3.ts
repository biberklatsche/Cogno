...
const ttl = 30000;
const appendFolderPath = (whatHasUserTyped: string, baseLSCommand: string[]): string[] => {
    let folderPath = "";
    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--recursive",
                    description: "Command is performed on all files or objects under the specified directory or prefix"
                },
                {
                    name: "--page-size",
                ...
                {
                    name: "--summarize",
                    description: "Displays summary information (number of objects, total size)"
                },
                {
                    name: "--request-payer",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--include",
                    description: "Don't exclude files or objects in the command that match the specified pattern. See Use of Exclude and Include Filters for details",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Do not try to guess the mime type for uploaded files.  By default the mime type of a file is guessed when it is uploaded"
                },
                {
                    name: "--sse",
                    description: "Specifies server-side encryption of the object in S3. Valid values are ``AES256`` and ``aws:kms``. If the parameter is specified but no value is provided, ``AES256`` is used",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--sse-c",
                    description: "Specifies server-side encryption using customer provided keys of the the object in S3. ``AES256`` is the only valid value. If the parameter is specified but no value is provided, ``AES256`` is used. If you provide this value, ``--sse-c-key`` must be specified as well",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--storage-class",
                    description: "The type of storage to use for the object. Valid choices are: STANDARD | REDUCED_REDUNDANCY | STANDARD_IA | ONEZONE_IA | INTELLIGENT_TIERING | GLACIER | DEEP_ARCHIVE. Defaults to 'STANDARD'",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--content-type",
                    description: "Specify an explicit content type for this operation.  This value overrides any guessed mime types",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Only errors and warnings are displayed. All other output is suppressed"
                },
                {
                    name: "--no-progress",
                    description: "File transfer progress is not displayed. This flag is only applied when the quiet and only-show-errors flags are not provided"
                },
                {
                    name: "--page-size",
                    description: "The number of results to return in each response to a list operation. The default value is 1000 (the maximum allowed). Using a lower value may help if an operation times out",
                ...
                },
                {
                    ...
                    description: "Turns off glacier warnings. Warnings about an operation that cannot be performed because it involves copying, downloading, or moving a glacier object will no longer be printed to standard error and will no longer cause the return code of the command to be ``2``"
                },
                {
                    name: "--force-glacier-transfer",
                    description: "Forces a transfer request on all Glacier objects in a sync or recursive copy"
                },
                {
                    name: "--request-payer",
                    description: "Confirms that the requester knows that they will be charged for the request. Bucket owners need not specify this parameter in their requests. Documentation on downloading objects from requester pays buckets can be found at http://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html",
                ...
                {
                    name: "--expected-size",
                    description: "This argument specifies the expected size of a stream in terms of bytes. Note that this argument is needed only when a stream is being uploaded to s3 and the size is larger than 50GB.  Failure to include this argument under these conditions may result in a failed upload due to too many parts in upload",
                    args: {
                        name: "string"
                    }
                },
        ...
        {
            name: "presign",
            description: "Generate a pre-signed URL for an Amazon S3 object. This allows anyone who receives the pre-signed URL to retrieve the S3 object with an HTTP GET request. For sigv4 requests the region needs to be configured explicitly",
            options: [
                {
                    name: "--expires-in",
                    description: "Number of seconds until the pre-signed URL expires.  Default is 3600 seconds",
                    args: {
                        name: "integer"
                    }
                }
