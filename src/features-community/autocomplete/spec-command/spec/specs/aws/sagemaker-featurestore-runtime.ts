    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--identifiers",
                    description: "A list containing the name or Amazon Resource Name (ARN) of the FeatureGroup, the list of names of Features to be retrieved, and the corresponding RecordIdentifier values as strings",
                    args: {
                        name: "list"
                    }
                },
                {
                    ...
                    description: "Parameter to request ExpiresAt in response. If Enabled, BatchGetRecord will return the value of ExpiresAt, if it is not null. If Disabled and null, BatchGetRecord will return null",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--target-stores",
                    description: "A list of stores from which you're deleting the record. By default, Feature Store deletes the record from all of the stores that you're using for the FeatureGroup",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--deletion-mode",
                    description: "The name of the deletion mode for deleting the record. By default, the deletion mode is set to SoftDelete",
                    args: {
                        name: "string"
                    }
                },
        ...
        {
            name: "get-record",
            description: "Use for OnlineStore serving from a FeatureStore. Only the latest records stored in the OnlineStore can be retrieved. If no Record with RecordIdentifierValue is found, then an empty result is returned",
            options: [
                {
                    name: "--feature-group-name",
                ...
                {
                    name: "--expiration-time-response",
                    description: "Parameter to request ExpiresAt in response. If Enabled, GetRecord will return the value of ExpiresAt, if it is not null. If Disabled and null, GetRecord will return null",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--record",
                    description: "List of FeatureValues to be inserted. This will be a full over-write. If you only want to update few of the feature values, do the following:   Use GetRecord to retrieve the latest record.   Update the record returned from GetRecord.    Use PutRecord to update feature values",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--target-stores",
                    description: "A list of stores to which you're adding the record. By default, Feature Store adds the record to all of the stores that you're using for the FeatureGroup",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--ttl-duration",
                    description: "Time to live duration, where the record is hard deleted after the expiration time is reached; ExpiresAt = EventTime + TtlDuration. For information on HardDelete, see the DeleteRecord API in the Amazon SageMaker API Reference guide",
                    args: {
                        name: "structure"
                    }
                },
