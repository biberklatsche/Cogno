...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Describes your OpsWorks-CM account attributes.   This operation is synchronous",
            options: [
                {
                    name: "--cli-input-json",
                    description: "Performs service operation based on the JSON string provided. The JSON string follows the format provided by ``--generate-cli-skeleton``. If other arguments are provided on the command line, the CLI values will override the JSON-provided values. It is not possible to pass arbitrary binary values using a JSON-provided value as the string will be taken literally",
        ...
        },
        {
            ...
            description: "Describes events for a specified server. Results are ordered by time, with newest events first.   This operation is synchronous.   A ResourceNotFoundException is thrown when the server does not exist. A ValidationException is raised when parameters of the request are not valid",
            options: [
                {
                    name: "--server-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--engine-attributes",
                    description: "Engine attributes that are used for disassociating the node. No attributes are required for Puppet.   Attributes required in a DisassociateNode request for Chef     CHEF_ORGANIZATION: The Chef organization with which the node was associated. By default only one organization named default can exist",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--engine-attributes",
                    description: "Engine attributes that are specific to the server on which you want to run maintenance.  Attributes accepted in a StartMaintenance request for Chef     CHEF_MAJOR_UPGRADE: If a Chef Automate server is eligible for upgrade to Chef Automate 2, add this engine attribute to a StartMaintenance request and set the value to true to upgrade the server to Chef Automate 2. For more information, see Upgrade an AWS OpsWorks for Chef Automate Server to Chef Automate 2",
                    args: {
                        name: "list"
                    }
                },
        ...
        {
            name: "update-server",
            description: "Updates settings for a server.   This operation is synchronous",
            options: [
                {
                    name: "--disable-automated-backup",
                ...
                {
                    name: "--preferred-maintenance-window",
                    description: "DDD:HH:MM (weekly start time) or HH:MM (daily start time).   Time windows always use coordinated universal time (UTC). Valid strings for day of week (DDD) are: Mon, Tue, Wed, Thr, Fri, Sat, or Sun",
                    args: {
                        name: "string"
                    }
                },
            ...
            subcommands: [
                {
                    ...
                    description: "Wait until node is associated or disassociated. It will poll every 15 seconds until a successful state has been reached. This will exit with a return code of 255 after 15 failed checks",
                    options: [
                        {
                            name: "--node-association-status-token",
                            description: "The token returned in either the AssociateNodeResponse or the DisassociateNodeResponse",
