    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--data",
                    description: "The alert manager definition to add. A base64-encoded version of the YAML alert manager definition file. For details about the alert manager definition, see AlertManagedDefinitionData",
                    args: {
                        name: "blob"
                    }
                },
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace to add the alert manager definition to",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--data",
                    description: "The rules file to use in the new namespace. Contains the base64-encoded version of the YAML rules file. For details about the rule groups namespace structure, see RuleGroupsNamespaceData",
                    args: {
                        name: "blob"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The configuration file to use in the new scraper. For more information, see Scraper configuration in the Amazon Managed Service for Prometheus User Guide",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--source",
                    description: "The Amazon EKS cluster from which the scraper will collect metrics",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--tags",
                    description: "(Optional) The list of tag keys and values to associate with the scraper",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--kms-key-arn",
                    description: "(optional) The ARN for a customer managed KMS key to use for encrypting data within your workspace. For more information about using your own key in your workspace, see Encryption at rest in the Amazon Managed Service for Prometheus User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace to delete the alert manager definition from",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace containing the logging configuration to delete",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace containing the rule groups namespace and definition to delete",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--name",
                    description: "Use this parameter to filter the rule groups namespaces that are returned. Only the namespaces with names that begin with the value that you specify are returned",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--next-token",
                    description: "The token for the next set of items to return. You receive this token from a previous call, and use it to get the next page of results. The other parameters must be the same as the initial call. For example, if your initial request has maxResults of 10, and there are 12 rule groups namespaces to return, then your initial request will return 10 and a nextToken. Using the next token in a subsequent call will return the remaining 2 namespaces",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "Optional) The maximum number of scrapers to return in one ListScrapers operation. The range is 1-1000. If you omit this parameter, the default of 100 is used",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of workspaces to return per request. The default is 100",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--data",
                    description: "The alert manager definition to use. A base64-encoded version of the YAML alert manager definition file. For details about the alert manager definition, see AlertManagedDefinitionData",
                    args: {
                        name: "blob"
                    }
                },
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace to update the alert manager definition in",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--data",
                    description: "The new rules file to use in the namespace. A base64-encoded version of the YAML rule groups file. For details about the rule groups namespace structure, see RuleGroupsNamespaceData",
                    args: {
                        name: "blob"
                    }
                },
                ...
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace where you are updating the rule groups namespace",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "The list of tag keys and values to associate with the resource. Keys must not begin with aws:",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--log-group-arn",
                    description: "The ARN of the CloudWatch log group to which the vended log data will be published",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--workspace-id",
                    description: "The ID of the workspace to update the logging configuration for",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--destination",
                    description: "The new Amazon Managed Service for Prometheus workspace to send metrics to",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--scrape-configuration",
                    description: "Contains the base-64 encoded YAML configuration for the scraper.  For more information about configuring a scraper, see Using an Amazon Web Services managed collector in the Amazon Managed Service for Prometheus User Guide",
                    args: {
                        name: "structure"
                    }
                },
