    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ARN of an IAM role that provides Neptune access to SageMaker and Amazon S3 resources. This must be listed in your DB cluster parameter group or an error will occur",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--clean",
                    description: "If set to TRUE, this flag specifies that all Neptune ML S3 artifacts should be deleted when the job is stopped. The default is FALSE"
                },
                {
                    name: "--no-clean",
                    description: "If set to TRUE, this flag specifies that all Neptune ML S3 artifacts should be deleted when the job is stopped. The default is FALSE"
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--clean",
                    description: "If set to TRUE, this flag specifies that all Amazon S3 artifacts should be deleted when the job is stopped. The default is FALSE"
                },
                {
                    name: "--no-clean",
                    description: "If set to TRUE, this flag specifies that all Amazon S3 artifacts should be deleted when the job is stopped. The default is FALSE"
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--clean",
                    description: "If this flag is set to TRUE, all Neptune ML S3 artifacts should be deleted when the job is stopped. The default is FALSE"
                },
                {
                    name: "--no-clean",
                    description: "If this flag is set to TRUE, all Neptune ML S3 artifacts should be deleted when the job is stopped. The default is FALSE"
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--silent",
                    description: "If set to TRUE, causes the cancelation of the openCypher query to happen silently"
                },
                {
                    name: "--no-silent",
                    description: "If set to TRUE, causes the cancelation of the openCypher query to happen silently"
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The job Id of the completed model-training job that has created the model that the inference endpoint will point to. You must supply either the mlModelTrainingJobId or the mlModelTransformJobId",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The job Id of the completed model-transform job. You must supply either the mlModelTrainingJobId or the mlModelTransformJobId",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--update",
                    description: "If set to true, update indicates that this is an update request. The default is false. You must supply either the mlModelTrainingJobId or the mlModelTransformJobId"
                },
                {
                    name: "--no-update",
                    description: "If set to true, update indicates that this is an update request. The default is false. You must supply either the mlModelTrainingJobId or the mlModelTransformJobId"
                ...
                {
                    name: "--neptune-iam-role-arn",
                    description: "The ARN of an IAM role providing Neptune access to SageMaker and Amazon S3 resources. This must be listed in your DB cluster parameter group or an error will be thrown",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--instance-type",
                    description: "The type of Neptune ML instance to use for online servicing. The default is ml.m5.xlarge. Choosing the ML instance for an inference endpoint depends on the task type, the graph size, and your budget",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--instance-count",
                    description: "The minimum number of Amazon EC2 instances to deploy to an endpoint for prediction. The default is 1",
                    args: {
                        name: "integer"
                    }
                },
                {
                    ...
                    description: "The Amazon Key Management Service (Amazon KMS) key that SageMaker uses to encrypt data on the storage volume attached to the ML compute instances that run the training job. The default is None",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--results",
                    description: "If this flag is set to TRUE, the query results are gathered and displayed as part of the profile report. If FALSE, only the result count is displayed"
                },
                {
                    name: "--no-results",
                    description: "If this flag is set to TRUE, the query results are gathered and displayed as part of the profile report. If FALSE, only the result count is displayed"
                ...
                {
                    name: "--chop",
                    description: "If non-zero, causes the results string to be truncated at that number of characters. If set to zero, the string contains all the results",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--serializer",
                    description: "If non-null, the gathered results are returned in a serialized response message in the format specified by this parameter. See Gremlin profile API in Neptune for more information",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--index-ops",
                    description: "If this flag is set to TRUE, the results include a detailed report of all index operations that took place during query execution and serialization"
                },
                {
                    name: "--no-index-ops",
                    description: "If this flag is set to TRUE, the results include a detailed report of all index operations that took place during query execution and serialization"
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--serializer",
                    description: "If non-null, the query results are returned in a serialized response message in the format specified by this parameter. See the GraphSON section in the TinkerPop documentation for a list of the formats that are currently supported",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--explain-mode",
                    description: "The openCypher explain mode. Can be one of: static, dynamic, or details",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--parameters",
                    description: "The openCypher query parameters for query execution. See Examples of openCypher parameterized queries for more information",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--details",
                    description: "Flag indicating whether or not to include details beyond the overall status (TRUE or FALSE; the default is FALSE)"
                },
                {
                    name: "--no-details",
                    description: "Flag indicating whether or not to include details beyond the overall status (TRUE or FALSE; the default is FALSE)"
                ...
                {
                    name: "--errors",
                    description: "Flag indicating whether or not to include a list of errors encountered (TRUE or FALSE; the default is FALSE). The list of errors is paged. The page and errorsPerPage parameters allow you to page through all the errors"
                },
                {
                    name: "--no-errors",
                    description: "Flag indicating whether or not to include a list of errors encountered (TRUE or FALSE; the default is FALSE). The list of errors is paged. The page and errorsPerPage parameters allow you to page through all the errors"
                ...
                {
                    name: "--page",
                    description: "The error page number (a positive integer; the default is 1). Only valid when the errors parameter is set to TRUE",
                    args: {
                        name: "integer"
                    }
                },
                {
                    ...
                    description: "The number of errors returned in each page (a positive integer; the default is 10). Only valid when the errors parameter set to TRUE",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--commit-num",
                    description: "The commit number of the starting record to read from the change-log stream. This parameter is required when iteratorType isAT_SEQUENCE_NUMBER or AFTER_SEQUENCE_NUMBER, and ignored when iteratorType is TRIM_HORIZON or LATEST",
                    args: {
                        name: "long"
                    }
                },
                {
                    name: "--op-num",
                    description: "The operation sequence number within the specified commit to start reading from in the change-log stream data. The default is 1",
                    args: {
                        name: "long"
                    }
                },
                {
                    name: "--encoding",
                    description: "If set to TRUE, Neptune compresses the response using gzip encoding",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "An optional parameter that can be used to exclude the load IDs of queued load requests when requesting a list of load IDs by setting the parameter to FALSE. The default value is TRUE"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The Amazon region of the S3 bucket. This must match the Amazon Region of the DB cluster",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--iam-role-arn",
                    description: "The Amazon Resource Name (ARN) for an IAM role to be assumed by the Neptune DB instance for access to the S3 bucket. The IAM role ARN provided here should be attached to the DB cluster (see Adding the IAM Role to an Amazon Neptune Cluster",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--fail-on-error",
                    description: 'FailOnError  \u00a0 \u2013 \u00a0 A flag to toggle a complete stop on an error.  Allowed values: "TRUE", "FALSE".  Default value: "TRUE". When this parameter is set to "FALSE", the loader tries to load all the data in the location specified, skipping any entries with errors. When this parameter is set to "TRUE", the loader stops as soon as it encounters an error. Data loaded up to that point persists'
                },
                {
                ...
                },
                {
                    ...
                    description: 'UpdateSingleCardinalityProperties is an optional parameter that controls how the bulk loader treats a new value for single-cardinality vertex or edge properties. This is not supported for loading openCypher data.  Allowed values: "TRUE", "FALSE".  Default value: "FALSE". By default, or when updateSingleCardinalityProperties is explicitly set to "FALSE", the loader treats a new value as an error, because it violates single cardinality. When updateSingleCardinalityProperties is set to "TRUE", on the other hand, the bulk loader replaces the existing value with the new one. If multiple edge or single-cardinality vertex property values are provided in the source file(s) being loaded, the final value at the end of the bulk load could be any one of those new values. The loader only guarantees that the existing value has been replaced by one of the new ones'
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The job ID of a completed data processing job run on an earlier version of the data",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The URI of the Amazon S3 location where you want SageMaker to download the data needed to run the data processing job",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The URI of the Amazon S3 location where you want SageMaker to save the results of a data processing job",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The ARN of an IAM role for SageMaker execution. This must be listed in your DB cluster parameter group or an error will occur",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--neptune-iam-role-arn",
                    description: "The Amazon Resource Name (ARN) of an IAM role that SageMaker can assume to perform tasks on your behalf. This must be listed in your DB cluster parameter group or an error will occur",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The type of ML instance used during data processing. Its memory should be large enough to hold the processed dataset. The default is the smallest ml.r5 type whose memory is ten times larger than the size of the exported graph data on disk",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The disk volume size of the processing instance. Both input data and processed data are stored on disk, so the volume size must be large enough to hold both data sets. The default is 0. If not specified or 0, Neptune ML chooses the volume size automatically based on the data size",
                    args: {
                        name: "integer"
                    }
                },
                {
                    ...
                    description: "Timeout in seconds for the data processing job. The default is 86,400 (1 day)",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--model-type",
                    description: "One of the two model types that Neptune ML currently supports: heterogeneous graph models (heterogeneous), and knowledge graph (kge). The default is none. If not specified, Neptune ML chooses the model type automatically based on the data",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "A data specification file that describes how to load the exported graph data for training. The file is automatically generated by the Neptune export toolkit. The default is training-data-configuration.json",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The Amazon Key Management Service (Amazon KMS) key that SageMaker uses to encrypt the output of the processing job. The default is none",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The job ID of a completed model-training job that you want to update incrementally based on updated data",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The job ID of the completed data-processing job that has created the data that the training will work with",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The location in Amazon S3 where the model artifacts are to be stored",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The type of ML instance used in preparing and managing training of ML models. This is a CPU instance chosen based on memory requirements for processing the training data and model",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The type of ML instance used for model training. All Neptune ML models support CPU, GPU, and multiGPU training. The default is ml.p3.2xlarge. Choosing the right instance type for training depends on the task type, graph size, and your budget",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Timeout in seconds for the training job. The default is 86,400 (1 day)",
                    args: {
                        name: "integer"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Maximum number of parallel training jobs to start for the hyperparameter tuning job. The default is 2. The number of parallel jobs you can run is limited by the available resources on your training instance",
                    args: {
                        name: "integer"
                    }
                },
                ...
                {
                    name: "--volume-encryption-kms-key",
                    description: "The Amazon Key Management Service (KMS) key that SageMaker uses to encrypt data on the storage volume attached to the ML compute instances that run the training job. The default is None",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--s3-output-encryption-kms-key",
                    description: "The Amazon Key Management Service (KMS) key that SageMaker uses to encrypt the output of the processing job. The default is none",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "Optimizes the cost of training machine-learning models by using Amazon Elastic Compute Cloud spot instances. The default is False"
                },
                {
                ...
                },
                {
                    ...
                    description: "The configuration for custom model training. This is a JSON object",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--data-processing-job-id",
                    description: "The job ID of a completed data-processing job. You must include either dataProcessingJobId and a mlModelTrainingJobId, or a trainingJobName",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--ml-model-training-job-id",
                    description: "The job ID of a completed model-training job. You must include either dataProcessingJobId and a mlModelTrainingJobId, or a trainingJobName",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The name of a completed SageMaker training job. You must include either dataProcessingJobId and a mlModelTrainingJobId, or a trainingJobName",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Configuration information for a model transform using a custom model. The customModelTransformParameters object contains the following fields, which must have values compatible with the saved model parameters from the training job:",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--base-processing-instance-type",
                    description: "The type of ML instance used in preparing and managing training of ML models. This is an ML compute instance chosen based on memory requirements for processing the training data and model",
                    args: {
                        name: "string"
                    }
                },
