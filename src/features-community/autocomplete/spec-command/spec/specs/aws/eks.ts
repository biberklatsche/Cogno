...
const listCustomGenerator = async (tokens: string[], executeShellCommand: ExecuteCommandFunction, command: string, options: string[], parentKey: string, childKey = ""): Promise<Suggestion[]> => {
    try {
...
const listRolesForPrincipal = (out: string, principal: string): Suggestion[] => {
    try {
...
const generators: Record<string, Generator> = {
    ...
    listAddonsForCluster: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "list-addons", ["--cluster-name"], "addons");
        },
    },
    listAddons: {
    ...
    listFargatePodRoles: {
        script: ["aws", "iam", "list-roles"],
        postProcess: (out) => listRolesForPrincipal(out, "eks-fargate-pods.amazonaws.com"),
    },
    listNodeGroupRoles: {
        script: ["aws", "iam", "list-roles"],
        postProcess: (out) => listRolesForPrincipal(out, "eks-nodegroup.amazonaws.com"),
    },
    ...
    listFargateProfilesForCluster: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "list-fargate-profiles", ["--cluster-name"], "fargateProfileNames");
        },
    },
    listNodeGroupsForCluster: {
        custom: async function (tokens, executeShellCommand) {
            return listCustomGenerator(tokens, executeShellCommand, "list-nodegroups", ["--cluster-name"], "nodegroups");
        },
    },
};
const completionSpec: CommandSpec = {
    name: "eks",
    description: "Amazon Elastic Kubernetes Service (Amazon EKS) is a managed service that makes it easy for you to run Kubernetes on Amazon Web Services without needing to setup or maintain your own Kubernetes control plane. Kubernetes is an open-source system for automating the deployment, scaling, and management of containerized applications. Amazon EKS runs up-to-date versions of the open-source Kubernetes software, so you can use all the existing plugins and tooling from the Kubernetes community. Applications running on Amazon EKS are fully compatible with applications running on any standard Kubernetes environment, whether running in on-premises data centers or public clouds. This means that you can easily migrate any standard Kubernetes application to Amazon EKS without any code modification required",
    subcommands: [
        {
            name: "associate-access-policy",
            description: "Associates an access policy and its scope to an access entry. For more information about associating access policies, see Associating and disassociating access policies to and from access entries in the Amazon EKS User Guide",
            options: [
                {
                    name: "--cluster-name",
                ...
                {
                    name: "--policy-arn",
                    description: "The ARN of the AccessPolicy that you're associating. For a list of ARNs, use ListAccessPolicies",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--access-scope",
                    description: "The scope for the AccessPolicy. You can scope access policies to an entire cluster or to specific Kubernetes namespaces",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The value for name that you've specified for kind: Group as a subject in a Kubernetes RoleBinding or ClusterRoleBinding object. Amazon EKS doesn't confirm that the value for name exists in any bindings on your cluster. You can specify one or more names. Kubernetes authorizes the principalArn of the access entry to access any cluster objects that you've specified in a Kubernetes Role or ClusterRole object that is also specified in a binding's roleRef. For more information about creating Kubernetes RoleBinding, ClusterRoleBinding, Role, or ClusterRole objects, see Using RBAC Authorization in the Kubernetes documentation. If you want Amazon EKS to authorize the principalArn (instead of, or in addition to Kubernetes authorizing the principalArn), you can associate one or more access policies to the access entry using AssociateAccessPolicy. If you associate any access policies, the principalARN has all permissions assigned in the associated access policies and all permissions in any Kubernetes Role or ClusterRole objects that the group names are bound to",
                    args: {
                        name: "list"
                    }
                },
        ...
        {
            name: "create-addon",
            description: "Creates an Amazon EKS add-on. Amazon EKS add-ons help to automate the provisioning and lifecycle management of common operational software for Amazon EKS clusters. For more information, see Amazon EKS add-ons in the Amazon EKS User Guide",
            options: [
                {
                    name: "--cluster-name",
                    description: "The name of your cluster",
                ...
                {
                    name: "--addon-version",
                    description: "The version of the add-on. The version must match one of the versions returned by  DescribeAddonVersions",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "An array of Pod Identity Assocations to be created. Each EKS Pod Identity association maps a Kubernetes service account to an IAM Role. For more information, see Attach an IAM Role to an Amazon EKS add-on using Pod Identity in the EKS User Guide",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--role-arn",
                    description: "The Amazon Resource Name (ARN) of the IAM role that provides permissions for the Kubernetes control plane to make calls to Amazon Web Services API operations on your behalf. For more information, see Amazon EKS Service IAM Role in the  Amazon EKS User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--term",
                    description: "An object representing the term duration and term unit type of your subscription. This determines the term length of your subscription. Valid values are MONTHS for term unit and 12 or 36 for term duration, indicating a 12 month or 36 month subscription. This value cannot be changed after creating the subscription",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "The number of licenses to purchase with the subscription. Valid values are between 1 and 100. This value can't be changed after creating the subscription",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--license-type",
                    description: "The license type for all licenses in the subscription. Valid value is CLUSTER. With the CLUSTER license type, each license covers support for a single EKS Anywhere cluster",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--auto-renew",
                    description: "A boolean indicating whether the subscription auto renews at the end of the term"
                },
                {
                    name: "--no-auto-renew",
                    description: "A boolean indicating whether the subscription auto renews at the end of the term"
                ...
                {
                    name: "--tags",
                    description: "The metadata for a subscription to assist with categorization and organization. Each tag consists of a key and an optional value. Subscription tags don't propagate to any other resources associated with the subscription",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The Amazon Resource Name (ARN) of the Pod execution role to use for a Pod that matches the selectors in the Fargate profile. The Pod execution role allows Fargate infrastructure to register with your cluster as a node, and it provides read access to Amazon ECR image repositories. For more information, see  Pod execution role in the Amazon EKS User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            description: "Creates a managed node group for an Amazon EKS cluster. You can only create a node group for your cluster that is equal to the current Kubernetes version for the cluster. All node groups are created with the latest AMI release version for the respective minor Kubernetes version of the cluster, unless you deploy a custom AMI using a launch template. For more information about using launch templates, see Customizing managed nodes with launch templates. An Amazon EKS managed node group is an Amazon EC2 Auto Scaling group and associated Amazon EC2 instances that are managed by Amazon Web Services for an Amazon EKS cluster. For more information, see Managed node groups in the Amazon EKS User Guide.  Windows AMI types are only supported for commercial Amazon Web Services Regions that support Windows on Amazon EKS",
            options: [
                {
                    name: "--cluster-name",
                    description: "The name of your cluster",
                ...
                {
                    name: "--taints",
                    description: "The Kubernetes taints to be applied to the nodes in the node group. For more information, see Node taints on managed node groups",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            description: "Deletes an access entry. Deleting an access entry of a type other than Standard can cause your cluster to function improperly. If you delete an access entry in error, you can recreate it",
            options: [
                {
                    name: "--cluster-name",
                    description: "The name of your cluster",
        ...
        {
            name: "delete-addon",
            description: "Deletes an Amazon EKS add-on. When you remove an add-on, it's deleted from the cluster. You can always manually start an add-on on the cluster using the Kubernetes API",
            options: [
                {
                    name: "--cluster-name",
                    description: "The name of your cluster",
                ...
                {
                    name: "--addon-name",
                    description: "The name of the add-on. The name must match one of the names returned by  ListAddons",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            description: "Deletes an expired or inactive subscription. Deleting inactive subscriptions removes them from the Amazon Web Services Management Console view and from list/describe API responses. Subscriptions can only be cancelled within 7 days of creation and are cancelled by creating a ticket in the Amazon Web Services Support Center",
            options: [
                {
                    name: "--id",
        ...
        },
        {
            ...
            description: "Deletes a EKS Pod Identity association. The temporary Amazon Web Services credentials from the previous IAM role session might still be valid until the session expiry. If you need to immediately revoke the temporary session credentials, then go to the role in the IAM console",
            options: [
                {
                    name: "--cluster-name",
        ...
        },
        {
            ...
            description: "Deregisters a connected cluster to remove it from the Amazon EKS control plane. A connected cluster is a Kubernetes cluster that you've connected to your control plane using the Amazon EKS Connector",
            options: [
                {
                    name: "--name",
        ...
        },
        {
            ...
            description: "Describes the versions for an add-on. Information such as the Kubernetes versions that you can use the add-on with, the owner, publisher, and the type of the add-on are returned",
            options: [
                {
                    name: "--kubernetes-version",
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of results, returned in paginated output. You receive maxResults in a single page, along with a nextToken response element. You can see the remaining results of the initial request by sending another request with the returned nextToken value. This value can be between 1 and 100. If you don't use this parameter, 100 results and a nextToken value, if applicable, are returned",
                    args: {
                        name: "integer"
                    }
                },
                ...
                {
                    name: "--types",
                    description: "The type of the add-on. For valid types, don't specify a value for this property",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--publishers",
                    description: "The publisher of the add-on. For valid publishers, don't specify a value for this property",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--owners",
                    description: "The owner of the add-on. For valid owners, don't specify a value for this property",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            description: "Returns descriptive information about an EKS Pod Identity association. This action requires the ID of the association. You can get the ID from the response to the CreatePodIdentityAssocation for newly created associations. Or, you can list the IDs for associations with ListPodIdentityAssociations and filter the list by namespace or service account",
            options: [
                {
                    name: "--cluster-name",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--nodegroup-name",
                    description: "The name of the Amazon EKS node group associated with the update. This parameter is required if the update is a node group update",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--addon-name",
                    description: "The name of the add-on. The name must match one of the names returned by  ListAddons . This parameter is required if the update is an add-on update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--policy-arn",
                    description: "The ARN of the policy to disassociate from the access entry. For a list of associated policies ARNs, use ListAssociatedAccessPolicies",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ARN of an AccessPolicy. When you specify an access policy ARN, only the access entries associated to that access policy are returned. For a list of available policy ARNs, use ListAccessPolicies",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--include",
                    description: "Indicates whether external clusters are included in the returned list. Use 'all' to return https://docs.aws.amazon.com/eks/latest/userguide/eks-connector.htmlconnected clusters, or blank to return only Amazon EKS clusters. 'all' must be in lowercase otherwise an error occurs",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--max-results",
                    description: "The maximum number of cluster results returned by ListEksAnywhereSubscriptions in paginated output. When you use this parameter, ListEksAnywhereSubscriptions returns only maxResults results in a single page along with a nextToken response element. You can see the remaining results of the initial request by sending another ListEksAnywhereSubscriptions request with the returned nextToken value. This value can be between 1 and 100. If you don't use this parameter, ListEksAnywhereSubscriptions returns up to 10 results and a nextToken value if applicable",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--next-token",
                    description: "The nextToken value returned from a previous paginated ListEksAnywhereSubscriptions request where maxResults was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the nextToken value",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filter",
                    description: "The criteria to filter your list of insights for your cluster. You can filter which insights are returned by category, associated Kubernetes version, and status",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--next-token",
                    description: "The nextToken value returned from a previous paginated ListInsights request. When the results of a ListInsights request exceed maxResults, you can use this value to retrieve the next page of results. This value is null when there are no more results to return",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The name of the Kubernetes namespace inside the cluster that the associations are in",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--service-account",
                    description: "The name of the Kubernetes service account that the associations use",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--next-token",
                    description: "The nextToken value returned from a previous paginated ListUpdates request where maxResults was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the nextToken value.  This token should be treated as an opaque identifier that is used only to retrieve the next items in a list and not for other programmatic purposes",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) that identifies the resource to list tags for",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--nodegroup-name",
                    description: "The name of the Amazon EKS managed node group to list updates for",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--name",
                    description: "A unique name for this cluster in your Amazon Web Services Region",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The configuration settings required to connect the Kubernetes cluster to the Amazon EKS control plane",
                    args: {
                        name: "structure"
                    }
                },
        ...
        {
            name: "tag-resource",
            description: "Associates the specified tags to an Amazon EKS resource with the specified resourceArn. If existing tags on a resource are not specified in the request parameters, they aren't changed. When a resource is deleted, the tags associated with that resource are also deleted. Tags that you create for Amazon EKS resources don't propagate to any other resources associated with the cluster. For example, if you tag a cluster with this operation, that tag doesn't automatically propagate to the subnets and nodes associated with the cluster",
            options: [
                {
                    name: "--resource-arn",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--upgrade-policy",
                    description: "You can enable or disable extended support for clusters currently on standard support. You cannot disable extended support once it starts. You must enable extended support before your cluster exits standard support",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--compute-config",
                    description: "Update the configuration of the compute capability of your EKS Auto Mode cluster. For example, enable the capability",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--storage-config",
                    description: "Update the configuration of the block storage capability of your EKS Auto Mode cluster. For example, enable the capability",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            description: "Update an EKS Anywhere Subscription. Only auto renewal and tags can be updated after subscription creation",
            options: [
                {
                    name: "--id",
                    description: "The ID of the subscription",
                ...
                {
                    name: "--auto-renew",
                    description: "A boolean indicating whether or not to automatically renew the subscription"
                },
                {
                    name: "--no-auto-renew",
                    description: "A boolean indicating whether or not to automatically renew the subscription"
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--labels",
                    description: "The Kubernetes labels to apply to the nodes in the node group after the update",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--taints",
                    description: "The Kubernetes taints to be applied to the nodes in the node group after the update. For more information, see Node taints on managed node groups",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--scaling-config",
                    description: "The scaling configuration details for the Auto Scaling group after the update",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--release-version",
                    description: "The AMI version of the Amazon EKS optimized AMI to use for the update. By default, the latest available AMI version for the node group's Kubernetes version is used. For information about Linux versions, see Amazon EKS optimized Amazon Linux AMI versions in the Amazon EKS User Guide. Amazon EKS managed node groups support the November 2022 and later releases of the Windows AMIs. For information about Windows versions, see Amazon EKS optimized Windows AMI versions in the Amazon EKS User Guide. If you specify launchTemplate, and your launch template uses a custom AMI, then don't specify releaseVersion, or the node group update will fail. For more information about using launch templates with Amazon EKS, see Customizing managed nodes with launch templates in the Amazon EKS User Guide",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--launch-template",
                    description: "An object representing a node group's launch template specification. You can only update a node group using a launch template if the node group was originally deployed with a launch template",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--cluster-name",
                    description: "The name of the cluster that you want to update the association in",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--name",
                    description: "The name of the cluster for which to create a kubeconfig entry. This cluster must exist in your account and in the specified or configured default Region for your AWS CLI installation",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--kubeconfig",
                    description: "Optionally specify a kubeconfig file to append with your configuration. By default, the configuration is written to the first file path in the KUBECONFIG environment variable (if it is set) or the default kubeconfig path (.kube/config) in your home directory",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--role-arn",
                    description: "To assume a role for cluster authentication, specify an IAM role ARN with this option. For example, if you created a cluster while assuming an IAM role, then you must also assume that role to connect to the cluster the first time",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--dry-run",
                    description: "Print the merged kubeconfig to stdout instead of writing it to the specified file"
                },
                {
                    name: "--verbose",
                    description: "Print more detailed output when writing to the kubeconfig file, including the appended entries"
                },
                {
                    name: "--alias",
                ...
                {
                    name: "--user-alias",
                    description: "Alias for the generated user name. Defaults to match cluster ARN",
                    args: {
                        name: "string"
                    }
                }
        ...
        },
        {
            ...
            options: [
                {
                    name: "--cluster-name",
                    description: "Specify the name of the Amazon EKS cluster to create a token for. (Note: for local clusters on AWS Outposts, please use --cluster-id parameter)",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--role-arn",
                    description: "Assume this role for credentials when signing the token. Use this optional parameter when the credentials for signing the token differ from that of the current role session. Using this parameter results in new role session credentials that are used to sign the token",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--cluster-id",
                    description: "Specify the id of the Amazon EKS cluster to create a token for. (Note: for local clusters on AWS Outposts only)",
                    args: {
                        name: "string"
                    }
                }
        ...
        },
        {
            ...
            subcommands: [
                {
                    name: "addon-active",
                    description: "Wait until JMESPath query addon.status returns ACTIVE when polling with ``describe-addon``. It will poll every 10 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
                ...
                {
                    name: "addon-deleted",
                    description: "Wait until ResourceNotFoundException is thrown when polling with ``describe-addon``. It will poll every 10 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
                ...
                {
                    name: "cluster-active",
                    description: "Wait until JMESPath query cluster.status returns ACTIVE when polling with ``describe-cluster``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 40 failed checks",
                    options: [
                        {
                            name: "--name",
                            description: "The name of your cluster",
                ...
                },
                {
                    ...
                    description: "Wait until ResourceNotFoundException is thrown when polling with ``describe-cluster``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 40 failed checks",
                    options: [
                        {
                            name: "--name",
                            description: "The name of your cluster",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query fargateProfile.status returns ACTIVE when polling with ``describe-fargate-profile``. It will poll every 10 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
                ...
                },
                {
                    ...
                    description: "Wait until ResourceNotFoundException is thrown when polling with ``describe-fargate-profile``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 60 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
                ...
                },
                {
                    ...
                    description: "Wait until JMESPath query nodegroup.status returns ACTIVE when polling with ``describe-nodegroup``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 80 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
                ...
                },
                {
                    ...
                    description: "Wait until ResourceNotFoundException is thrown when polling with ``describe-nodegroup``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 40 failed checks",
                    options: [
                        {
                            name: "--cluster-name",
                            description: "The name of your cluster",
