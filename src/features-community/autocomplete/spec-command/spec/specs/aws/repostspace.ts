    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--name",
                    description: "The name for the private re:Post. This must be unique in your account",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--role-arn",
                    description: "The IAM role that grants permissions to the private re:Post to convert unanswered questions into AWS support tickets",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--subdomain",
                    description: "The subdomain that you use to access your AWS re:Post Private private re:Post. All custom subdomains must be approved by AWS before use. In addition to your custom subdomain, all private re:Posts are issued an AWS generated subdomain for immediate use",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--user-kms-key",
                    description: "The AWS KMS key ARN that\u2019s used for the AWS KMS encryption. If you don't provide a key, your data is encrypted by default with a key that AWS owns and manages for you",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "The token for the next set of private re:Posts to return. You receive this token from a previous ListSpaces operation",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "The list of tag keys and values that must be associated with the resource. You can associate tag keys only, tags (key and values) only, or a combination of tag keys and tags",
                    args: {
                        name: "map"
                    }
                },
