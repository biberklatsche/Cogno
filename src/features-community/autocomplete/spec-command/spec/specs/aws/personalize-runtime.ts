    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--num-results",
                    description: "The number of results to return. The default is 5. The maximum is 100",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--input-list",
                    description: "A list of items (by itemId) to rank. If an item was not included in the training dataset, the item is appended to the end of the reranked list. If you are including metadata in recommendations, the maximum is 50. Otherwise, the maximum is 500",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--num-results",
                    description: "The number of results to return. The default is 25. If you are including metadata in recommendations, the maximum is 50. Otherwise, the maximum is 500",
                    args: {
                        name: "integer"
                    }
                },
