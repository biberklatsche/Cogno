    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--kind",
                    description: "The format in which Dataset data is structured.    TABULAR \u2013 Data is structured in a tabular format.    NON_TABULAR \u2013 Data is structured in a non-tabular format",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--api-access",
                    description: "The option to indicate whether the user can use the GetProgrammaticAccessCredentials API to obtain credentials that can then be used to access other FinSpace Data API operations.    ENABLED \u2013 The user has permissions to use the APIs.    DISABLED \u2013 The user does not have permissions to use any APIs",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--kind",
                    description: "The format in which the Dataset data is structured.    TABULAR \u2013 Data is structured in a tabular format.    NON_TABULAR \u2013 Data is structured in a non-tabular format",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The option to indicate the type of user.    SUPER_USER\u2013 A user with permission to all the functionality and data in FinSpace.    APP_USER \u2013 A user with specific permissions in FinSpace. The users are assigned permissions by adding them to a permission group",
                    args: {
                        name: "string"
                    }
                },
