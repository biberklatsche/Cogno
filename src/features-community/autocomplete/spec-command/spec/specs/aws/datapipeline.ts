    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The JSON parameter objects.  If the parameter objects are\nin a file you can use the file:// syntax to\nspecify a filename. You can optionally provide these in\npipeline definition as well. Parameter objects provided\non command line would replace the one in definition",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The JSON pipeline definition.  If the pipeline definition\nis in a file you can use the file:// syntax to\nspecify a filename",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--status",
                    description: "Filters the list to include only runs in the specified statuses. The valid statuses are as follows: waiting, pending, cancelled, running, finished, failed, waiting_for_runner, and waiting_on_dependencies",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--start-interval",
                    description: "Filters the list to include only runs that started within the specified interval",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "Filters the list to include only runs that are scheduled to start within the specified interval",
                    args: {
                        name: "string"
                    }
                }
