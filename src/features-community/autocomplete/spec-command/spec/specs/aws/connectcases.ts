    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--performed-by",
                    description: "Represents the identity of the person who performed the action",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of audit events to return. The current maximum supported value is 25. This is also the default when no other value is provided",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--fields",
                    description: "An array of objects with fieldId (matching ListFields/DescribeField) and value union data, structured identical to CreateCase",
                    args: {
                        name: "list"
                    }
                },
