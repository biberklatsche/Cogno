    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID for the topic reviewed answer that you want to create. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID for the topic reviewed answer that you want to delete. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: 'The Amazon QuickSight customizations you\'re adding in the current Amazon Web Services Region. You can add these to an Amazon Web Services account and a QuickSight namespace.  For example, you can add a default theme by setting AccountCustomization to the midnight theme: "AccountCustomization": { "DefaultTheme": "arn:aws:quicksight::aws:theme/MIDNIGHT" }. Or, you can add a custom theme by specifying "AccountCustomization": { "DefaultTheme": "arn:aws:quicksight:us-west-2:111122223333:theme/bdb844d0-0fe9-4d9d-b520-0fe602d93639" }',
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--account-name",
                    description: "The name of your Amazon QuickSight account. This name is unique over all of Amazon Web Services, and it appears only when users sign in. You can't change AccountName value after the Amazon QuickSight account is created",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The name of your Active Directory. This field is required if ACTIVE_DIRECTORY is the selected authentication method of the new Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--realm",
                    description: "The realm of the Active Directory that is associated with your Amazon QuickSight account. This field is required if ACTIVE_DIRECTORY is the selected authentication method of the new Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The author pro group associated with your Active Directory or IAM Identity Center account. For more information about using IAM Identity Center in Amazon QuickSight, see Using IAM Identity Center with Amazon QuickSight Enterprise Edition in the Amazon QuickSight User Guide. For more information about using Active Directory in Amazon QuickSight, see Using Active Directory with Amazon QuickSight Enterprise Edition in the Amazon QuickSight User Guide",
                    args: {
                        name: "list"
                    }
                },
                {
                    ...
                    description: "The reader pro group associated with your Active Directory or IAM Identity Center account. For more information about using IAM Identity Center in Amazon QuickSight, see Using IAM Identity Center with Amazon QuickSight Enterprise Edition in the Amazon QuickSight User Guide. For more information about using Active Directory in Amazon QuickSight, see Using Active Directory with Amazon QuickSight Enterprise Edition in the Amazon QuickSight User Guide",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--first-name",
                    description: "The first name of the author of the Amazon QuickSight account to use for future communications. This field is required if ENTERPPRISE_AND_Q is the selected edition of the new Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--last-name",
                    description: "The last name of the author of the Amazon QuickSight account to use for future communications. This field is required if ENTERPPRISE_AND_Q is the selected edition of the new Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--email-address",
                    description: "The email address of the author of the Amazon QuickSight account to use for future communications. This field is required if ENTERPPRISE_AND_Q is the selected edition of the new Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--source-entity",
                    description: "A source entity to use for the analysis that you're creating. This metadata structure contains details that describe a source template and one or more datasets. Either a SourceEntity or a Definition must be provided in order for the request to be valid",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--definition",
                    description: "The definition of an analysis. A definition is the data model of all features in a Dashboard, Template, or Analysis. Either a SourceEntity or a Definition must be provided in order for the request to be valid",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "The option to relax the validation needed to create an analysis with definition objects. This skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--folder-arns",
                    description: "When you create the analysis, Amazon QuickSight adds the analysis to these folders",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "A map of the key-value pairs that are assigned to the brand",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The name of the custom permissions profile that you want to create",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--capabilities",
                    description: "A set of actions to include in the custom permissions profile",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--tags",
                    description: "The tags to associate with the custom permissions profile",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--permissions",
                    description: "A structure that contains the permissions of the dashboard. You can use this structure for granting permissions by providing a list of IAM action information for each principal ARN.  To specify no permissions, omit the permissions list",
                    args: {
                        name: "list"
                    }
                },
                ...
                {
                    name: "--definition",
                    description: "The definition of a dashboard. A definition is the data model of all features in a Dashboard, Template, or Analysis. Either a SourceEntity or a Definition must be provided in order for the request to be valid",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--validation-strategy",
                    description: "The option to relax the validation needed to create a dashboard with definition objects. This option skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--folder-arns",
                    description: "When you create the dashboard, Amazon QuickSight adds the dashboard to these folders",
                    args: {
                        name: "list"
                    }
                },
                {
                    ...
                    description: "A structure that contains the permissions of a shareable link to the dashboard",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The type of the data source. To return a list of all data sources, use ListDataSources. Use AMAZON_ELASTICSEARCH for Amazon OpenSearch Service",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--folder-arns",
                    description: "When you create the data source, Amazon QuickSight adds the data source to these folders",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The Amazon Resource Name (ARN) for the parent folder.  ParentFolderArn can be null. An empty parentFolderArn creates a root-level folder",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--permissions",
                    description: "A structure that describes the principals and the resource-level permissions of a folder. To specify no permissions, omit Permissions",
                    args: {
                        name: "list"
                    }
                },
                ...
                {
                    name: "--sharing-model",
                    description: "An optional parameter that determines the sharing scope of the folder. The default value for this parameter is ACCOUNT",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--member-type",
                    description: "The member type of the asset that you want to add to a folder",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The name of the assignment, also called a rule. The name must be unique within the Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--identity-store",
                    description: "Specifies the type of your user identity directory. Currently, this supports users with an identity type of QUICKSIGHT",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--aws-account-id",
                    description: "The ID for the Amazon Web Services account that you want to create a group in. The Amazon Web Services account ID that you provide must be the same Amazon Web Services account that contains your Amazon QuickSight account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--definition",
                    description: "The definition of a template. A definition is the data model of all features in a Dashboard, Template, or Analysis. Either a SourceEntity or a Definition must be provided in order for the request to be valid",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--validation-strategy",
                    description: "TThe option to relax the validation needed to create a template with definition objects. This skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--alias-name",
                    description: "The name that you want to give to the template alias that you're creating. Don't start the alias name with the $ character. Alias names that start with $ are reserved by Amazon QuickSight",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--alias-name",
                    description: "The name that you want to give to the theme alias that you are creating. The alias name can't begin with a $. Alias names that start with $ are reserved by Amazon QuickSight",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--folder-arns",
                    description: "The Folder ARN of the folder that you want the topic to reside in",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID of the topic that you want to modify. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A value that specifies the number of days that Amazon QuickSight waits before it deletes the analysis. You can't use this parameter with the ForceDeleteWithoutRecovery option in the same API call. The default value is 30",
                    args: {
                        name: "long"
                    }
                },
                {
                    ...
                    description: "This option defaults to the value NoForceDeleteWithoutRecovery. To immediately delete the analysis, add the ForceDeleteWithoutRecovery option. You can't restore an analysis after it's deleted"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--custom-permissions-name",
                    description: "The name of the custom permissions profile that you want to delete",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The Amazon QuickSight namespace that you want to delete a linked Amazon Q Business application from. If this field is left blank, the Amazon Q Business application is deleted from the default namespace. Currently, the default namespace is the only valid value for this parameter",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--member-type",
                    description: "The member type of the asset that you want to delete from a folder",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--service",
                    description: "The name of the Amazon Web Services service that you want to delete the associated access scopes and authorized targets from",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-number",
                    description: "Specifies the version of the template that you want to delete. If you don't provide a version number, DeleteTemplate deletes all versions of the template",
                    args: {
                        name: "long"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--alias-name",
                    description: "The name for the template alias. To delete a specific alias, you delete the version that the alias points to. You can specify the alias name, or specify the latest version of the template by providing the keyword $LATEST in the AliasName parameter",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-number",
                    description: "The version of the theme that you want to delete.   Note: If you don't provide a version number, you're using this call to DeleteTheme to delete all versions of the theme",
                    args: {
                        name: "long"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID of the topic that you want to delete. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--aws-account-id",
                    description: "The ID of the Amazon Web Services account that contains the custom permission configuration that you want to delete",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resolved",
                    description: "The Resolved flag works with the other parameters to determine which view of Amazon QuickSight customizations is returned. You can add this flag to your command to use the same view that Amazon QuickSight uses to identify which customizations to apply to the console. Omit this flag, or set it to no-resolved, to reveal customizations that are configured at different levels"
                },
                {
                    name: "--no-resolved",
                    description: "The Resolved flag works with the other parameters to determine which view of Amazon QuickSight customizations is returned. You can add this flag to your command to use the same view that Amazon QuickSight uses to identify which customizations to apply to the console. Omit this flag, or set it to no-resolved, to reveal customizations that are configured at different levels"
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ID of the job that you want described. The job ID is set when you start a new job with a StartAssetBundleExportJob API call",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ID of the job. The job ID is set when you start a new job with a StartAssetBundleImportJob API call",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-id",
                    description: "The ID of the specific version. The default value is the latest version",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--dashboard-id",
                    description: "The ID of the dashboard that you have started a snapshot job for",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The Amazon QuickSight namespace that contains the linked Amazon Q Business application. If this field is left blank, the default namespace is used. Currently, the default namespace is the only valid value for this parameter",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The namespace of the folder whose permissions you want described",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Determines whether the request returns the default key only"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-number",
                    description: "(Optional) The number for the version to describe. If a VersionNumber parameter value isn't provided, the latest version of the template is described",
                    args: {
                        name: "long"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-number",
                    description: "The version number for the version to describe. If a VersionNumber parameter value isn't provided, the latest version of the theme is described",
                    args: {
                        name: "long"
                    }
                },
                {
                    name: "--alias-name",
                    description: "The alias of the theme that you want to describe. If you name a specific alias, you describe the version that the alias points to. You can specify the latest version of the theme by providing the keyword $LATEST in the AliasName parameter. The keyword $PUBLISHED doesn't apply to themes",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID of the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--refresh-id",
                    description: "The ID of the refresh, which is performed when the topic is created or updated",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID of the topic that contains the refresh schedule that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The Amazon QuickSight namespace that the anonymous user virtually belongs to. If you are not using an Amazon QuickSight custom namespace, set this to default",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--session-tags",
                    description: "The session tags used for row-level security. Before you use this parameter, make sure that you have configured the relevant datasets using the DataSet$RowLevelPermissionTagConfiguration parameter so that session tags can be used to provide row-level security. These are not the tags used for the Amazon Web Services resource tagging feature. For more information, see Using Row-Level Security (RLS) with Tagsin the Amazon QuickSight User Guide",
                    args: {
                        name: "list"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The domains that you want to add to the allow list for access to the generated URL that is then embedded. This optional parameter overrides the static domains that are configured in the Manage QuickSight menu in the Amazon QuickSight console. Instead, it allows only the domains that you include in this parameter. You can list up to three domains or subdomains in each API call. To include all subdomains under a specific domain to the allow list, use *. For example, https://*.sapp.amazon.com includes all subdomains under https://sapp.amazon.com",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--experience-configuration",
                    description: "The experience that you want to embed. For registered users, you can embed Amazon QuickSight dashboards, Amazon QuickSight visuals, the Amazon QuickSight Q search bar, the Amazon QuickSight Generative Q&A experience, or the entire Amazon QuickSight console",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--experience-configuration",
                    description: "The type of experience you want to embed. For registered users, you can embed Amazon QuickSight dashboards or the Amazon QuickSight console.  Exactly one of the experience configurations is required. You can choose Dashboard or QuickSightConsole. You cannot choose more than one experience configuration",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--allowed-domains",
                    description: "A list of domains to be allowed to generate the embed URL",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--user-arn",
                    description: "The Amazon QuickSight user's Amazon Resource Name (ARN), for use with QUICKSIGHT identity type. You can use this for any Amazon QuickSight users in your account (readers, authors, or admins) authenticated as one of the following:   Active Directory (AD) users or group members   Invited nonfederated users   IAM users and IAM role-based sessions authenticated through Federated Single Sign-On using SAML, OpenID Connect, or IAM federation.   Omit this parameter for users in the third group \u2013 IAM users and IAM role-based sessions",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--namespace",
                    description: "The Amazon QuickSight namespace that contains the dashboard IDs in this request. If you're not using a custom namespace, set Namespace = default",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: 'A list of one or more dashboard IDs that you want anonymous users to have tempporary access to. Currently, the IdentityType parameter must be set to ANONYMOUS because other identity types authenticate as Amazon QuickSight or IAM users. For example, if you set "--dashboard-id dash_id1 --dashboard-id dash_id2 dash_id3 identity-type ANONYMOUS", the session can access all three dashboards',
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--user-arn",
                    description: "The Amazon QuickSight user's Amazon Resource Name (ARN), for use with QUICKSIGHT identity type. You can use this for any type of Amazon QuickSight users in your account (readers, authors, or admins). They need to be authenticated as one of the following:   Active Directory (AD) users or group members   Invited nonfederated users   IAM users and IAM role-based sessions authenticated through Federated Single Sign-On using SAML, OpenID Connect, or IAM federation   Omit this parameter for users in the third group, IAM users and IAM role-based sessions",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arn",
                    description: "The Amazon Resource Name (ARN) the resource whose folders you need to list",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--type",
                    description: "The type of themes that you want to list. Valid options include the following:    ALL (default)- Display all existing themes.    CUSTOM - Display only the themes created by people using Amazon QuickSight.    QUICKSIGHT - Display only the starting themes defined by Amazon QuickSight",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID for the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--topic-id",
                    description: "The ID for the topic that contains the reviewed answer that you want to list. This ID is unique per Amazon Web Services Region for each Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Indicates whether generated answers are included or excluded",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The number of maximum topics to be considered to predict QA results",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The URL of the custom OpenID Connect (OIDC) provider that provides identity to let a user federate into Amazon QuickSight with an associated Identity and Access Management(IAM) role. This parameter should only be used when ExternalLoginFederationProviderType parameter is set to CUSTOM_OIDC",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: 'The filters to apply to the search. Currently, you can search only by user name, for example, "Filters": [ { "Name": "QUICKSIGHT_USER", "Operator": "StringEquals", "Value": "arn:aws:quicksight:us-east-1:1:user/default/UserName1" } ]',
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: 'The filters to apply to the search. Currently, you can search only by the parent folder ARN. For example, "Filters": [ { "Name": "PARENT_FOLDER_ARN", "Operator": "StringEquals", "Value": "arn:aws:quicksight:us-east-1:1:folder/folderId" } ]',
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filters",
                    description: "The filters that you want to use to search for the topic",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arns",
                    description: "An array of resource ARNs to export. The following resources are supported.    Analysis     Dashboard     DataSet     DataSource     RefreshSchedule     Theme     VPCConnection    The API caller must have the necessary permissions in their IAM role to access each resource before the resources can be exported",
                    args: {
                        name: "list"
                    }
                },
                {
                    ...
                    description: "A Boolean that determines whether all dependencies of each resource ARN are recursively exported with the job. For example, say you provided a Dashboard ARN to the ResourceArns parameter. If you set IncludeAllDependencies to TRUE, any theme, dataset, and data source resource that is a dependency of the dashboard is also exported"
                },
                {
                ...
                },
                {
                    ...
                    description: "A Boolean that determines whether all permissions for each resource ARN are exported with the job. If you set IncludePermissions to TRUE, any permissions associated with each resource are exported"
                },
                {
                ...
                {
                    name: "--include-tags",
                    description: "A Boolean that determines whether all tags for each resource ARN are exported with the job. If you set IncludeTags to TRUE, any tags associated with each resource are exported"
                },
                {
                ...
                },
                {
                    ...
                    description: "A Boolean that determines if the exported asset carries over information about the folders that the asset is a member of"
                },
                {
                ...
                },
                {
                    ...
                    description: "A setting that indicates whether you want to include folder assets. You can also use this setting to recusrsively include all subfolders of an exported folder",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The source of the asset bundle zip file that contains the data that you want to import. The file must be in QUICKSIGHT_JSON format. To specify a local file use --asset-bundle-import-source-bytes instead",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "Optional overrides that are applied to the resource configuration before import",
                    args: {
                        name: "structure"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Optional permission overrides that are applied to the resource configuration before import",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--override-tags",
                    description: "Optional tag overrides that are applied to the resource configuration before import",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "An optional validation strategy override for all analyses and dashboards that is applied to the resource configuration before import",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "The content of the asset bundle to be uploaded. To specify the content of a local file use the fileb:// prefix. Example: fileb://asset-bundle.zip",
                    args: {
                        name: "blob"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--snapshot-job-id",
                    description: "An ID for the dashboard snapshot job. This ID is unique to the dashboard while the job is running. This ID can be used to poll the status of a job with a DescribeDashboardSnapshotJob while the job runs. You can reuse this ID for another job 24 hours after the current job is completed",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "A structure that contains information about the anonymous users that the generated snapshot is for. This API will not return information about registered Amazon QuickSight",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "A structure that describes the configuration of the dashboard snapshot",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--dashboard-id",
                    description: "The ID of the dashboard that you want to start a snapshot job schedule for",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--schedule-id",
                    description: "The ID of the schedule that you want to start a snapshot job schedule for. The schedule ID can be found in the Amazon QuickSight console in the Schedules pane of the dashboard that the schedule is configured for",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The default namespace for this Amazon Web Services account. Currently, the default is default. IAM users that register for the first time with Amazon QuickSight provide an email address that becomes associated with the default namespace",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "A boolean value that determines whether or not an Amazon QuickSight account can be deleted. A True value doesn't allow the account to be deleted and results in an error message if a user tries to make a DeleteAccountSubscription request. A False value will allow the account to be deleted"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--definition",
                    description: "The definition of an analysis. A definition is the data model of all features in a Dashboard, Template, or Analysis",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--validation-strategy",
                    description: "The option to relax the validation needed to update an analysis with definition objects. This skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--custom-permissions-name",
                    description: "The name of the custom permissions profile that you want to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--definition",
                    description: "The definition of a dashboard. A definition is the data model of all features in a Dashboard, Template, or Analysis",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--validation-strategy",
                    description: "The option to relax the validation needed to update a dashboard with definition objects. This skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--link-entities",
                    description: "List of analysis Amazon Resource Names (ARNs) to be linked to the dashboard",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The status of dashboards QA configuration that you want to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--application-id",
                    description: "The ID of the Amazon Q Business application that you want to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--grant-permissions",
                    description: "The permissions that you want to grant on a resource. Namespace ARNs are not supported Principal values for folder permissions",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--revoke-permissions",
                    description: "The permissions that you want to revoke from a resource. Namespace ARNs are not supported Principal values for folder permissions",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--service",
                    description: "The name of the Amazon Web Services service that contains the authorized targets that you want to add or update",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "Specifies a list of application ARNs that represent the authorized targets for a service",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A map of VPC IDs and their corresponding rules. When you configure this parameter, traffic from all VPC endpoints that are present in the specified VPC is allowed",
                    args: {
                        name: "map"
                    }
                },
                {
                    ...
                    description: "A map of allowed VPC endpoint IDs and their corresponding rule descriptions",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "A list of RegisteredCustomerManagedKey objects to be updated to the Amazon QuickSight account",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "An option to allow Amazon QuickSight to customize data stories with user specific metadata, specifically location and job information, in your IAM Identity Center instance",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The status of the Amazon QuickSight Q Search configuration that the user wants to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The namespace that contains the role that you want to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--purchase-mode",
                    description: "Determines how SPICE capacity can be purchased. The following options are available.     MANUAL: SPICE capacity can only be purchased manually.    AUTO_PURCHASE: Extra SPICE capacity is automatically purchased on your behalf as needed. SPICE capacity can also be purchased manually with this option",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-description",
                    description: "A description of the current template version that is being updated. Every time you call UpdateTemplate, you create a new version of the template. Each version of the template maintains a description of the version in the VersionDescription field",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--definition",
                    description: "The definition of a template. A definition is the data model of all features in a Dashboard, Template, or Analysis",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--validation-strategy",
                    description: "The option to relax the validation needed to update a template with definition objects. This skips the validation step for specific errors",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--alias-name",
                    description: "The alias of the template that you want to update. If you name a specific alias, you update the version that the alias points to. You can specify the latest version of the template by providing the keyword $LATEST in the AliasName parameter. The keyword $PUBLISHED doesn't apply to templates",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--version-description",
                    description: "A description of the theme version that you're updating Every time that you call UpdateTheme, you create a new version of the theme. Each version of the theme maintains a description of the version in VersionDescription",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--revoke-permissions",
                    description: "The resource permissions that you want to revoke from the topic",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--aws-account-id",
                    description: "The ID of the Amazon Web Services account that contains the custom permission configuration that you want to update",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--custom-permissions-name",
                    description: "The name of the custom permissions that you want to update",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--vpc-connection-id",
                    description: "The ID of the VPC connection that you're updating. This ID is a unique identifier for each Amazon Web Services Region in an Amazon Web Services account",
                    args: {
                        name: "string"
                    }
                },
