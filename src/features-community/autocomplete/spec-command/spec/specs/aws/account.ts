    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--otp",
                    description: "The OTP code sent to the PrimaryEmail specified on the StartPrimaryEmailUpdate API call",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--primary-email",
                    description: "The new primary email address for use with the specified account. This must match the PrimaryEmail from the StartPrimaryEmailUpdate API call",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--region-name",
                    description: "Specifies the Region-code for a given Region name (for example, af-south-1). This function will return the status of whatever Region you pass into this parameter",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--next-token",
                    description: "A token used to specify where to start paginating. This is the NextToken from a previously truncated response. For usage examples, see Pagination in the Amazon Web Services Command Line Interface User Guide",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "A list of Region statuses (Enabling, Enabled, Disabling, Disabled, Enabled_by_default) to use to filter the list of Regions for a given account. For example, passing in a value of ENABLING will only return a list of Regions with a Region status of ENABLING",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--primary-email",
                    description: "The new primary email address (also known as the root user email address) to use in the specified account",
                    args: {
                        name: "string"
                    }
                },
