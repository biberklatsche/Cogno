    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--exclude-resource-tags",
                    description: "[Region-level retention rules only] Information about the exclusion tags used to identify resources that are to be excluded, or ignored, by the retention rule",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-type",
                    description: "This parameter is currently not supported. You can't update a retention rule's resource type after creation",
                    args: {
                        name: "string"
                    }
                },
