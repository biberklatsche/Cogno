    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--subscription-provider-sources",
                    description: "To filter your results, specify which subscription providers to return in the list",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--subscription-provider-source",
                ...
                {
                    name: "--tags",
                    description: "The metadata tags to assign to your registered Linux subscription provider resource",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "The metadata tags to assign to the Amazon Web Services resource. Tags are formatted as key value pairs",
                    args: {
                        name: "map"
                    }
                },
