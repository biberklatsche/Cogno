    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-query",
                    description: "The resource query that determines which Amazon Web Services resources are members of this group. For more information about resource queries, see Create a tag-based group in Resource Groups.   A resource group can contain either a ResourceQuery or a Configuration, but not both",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--configuration",
                    description: "A configuration associates the resource group with an Amazon Web Services service and specifies how the service can interact with the resources in the group. A configuration is an array of GroupConfigurationItem elements. For details about the syntax of service configurations, see Service configurations for Resource Groups.  A resource group can contain either a Configuration or a ResourceQuery, but not both",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--criticality",
                    description: "The critical rank of the application group on a scale of 1 to 10, with a rank of 1 being the most critical, and a rank of 10 being least critical",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--owner",
                    description: "A name, email address or other identifier for the person or group who is considered as the owner of this application group within your organization",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--display-name",
                    description: "The name of the application group, which you can change at any time",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--group",
                    description: "The name or the Amazon resource name (ARN) of the resource group to delete",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--group",
                    description: "The name or the Amazon resource name (ARN) of the resource group to retrieve",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--group",
                    description: "The name or the Amazon resource name (ARN) of the resource group to query",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arns",
                    description: "The list of Amazon resource names (ARNs) of the resources to be added to the group",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of resources and their statuses returned in the response",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--filters",
                    description: "The filter name and value pair that is used to return more specific results from a list of resources",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arns",
                    description: "The Amazon resource names (ARNs) of the resources to be removed from the group",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-query",
                    description: "The resource query to determine which Amazon Web Services resources are members of this resource group.  A resource group can contain either a Configuration or a ResourceQuery, but not both",
                    args: {
                        name: "structure"
                    }
                },
