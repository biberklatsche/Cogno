    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook where the new rows are being added.  If a workbook with the specified ID could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table where the new rows are being added.  If a table with the specified ID could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook where the rows are being deleted.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table where the rows are being deleted.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--row-ids",
                    description: "The list of row ids to delete from the table. You need to specify at least one row id in this list.   Note that if one of the row ids provided in the request does not exist in the table, then the request fails and no rows are deleted from the table",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook where the rows are being updated.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table where the rows are being updated.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook where the rows are being upserted.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table where the rows are being upserted.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook into which data was imported.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table into which data was imported.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--job-id",
                    description: "The ID of the job that was returned by the StartTableDataImportJob request.  If a job with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The number of results to be returned on a single page. Specify a number between 1 and 100. The maximum value is 100.   This parameter is optional. If you don't specify this parameter, the default page size is 100",
                    args: {
                        name: "integer"
                    }
                },
                {
                    name: "--next-token",
                    description: "This parameter is optional. If a nextToken is not specified, the API returns the first page of data.   Pagination tokens expire after 1 hour. If you use a token that was returned more than an hour back, the API will throw ValidationException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook that contains the table whose columns are being retrieved.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table whose columns are being retrieved.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook that contains the table whose rows are being retrieved.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table whose rows are being retrieved.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook whose tables are being retrieved.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook whose table rows are being queried.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--table-id",
                    description: "The ID of the table whose rows are being queried.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--workbook-id",
                    description: "The ID of the workbook where the rows are being imported.  If a workbook with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The ID of the table where the rows are being imported.  If a table with the specified id could not be found, this API throws ResourceNotFoundException",
                    args: {
                        name: "string"
                    }
                },
