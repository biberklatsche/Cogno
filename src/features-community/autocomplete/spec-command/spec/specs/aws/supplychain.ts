    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--s3uri",
                    description: "The S3 URI of the CSV file to be imported. The bucket must grant permissions for AWS Supply Chain to read the file",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The name space of the dataset.    asc - For information on the Amazon Web Services Supply Chain supported datasets see https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html.    default - For datasets with custom user-defined schemas",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--name",
                    description: "The name of the dataset. For asc name space, the name must be one of the supported data entities under https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--schema",
                    description: "The custom schema of the data lake dataset and is only required when the name space is default",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--kms-key-arn",
                    description: "The ARN (Amazon Resource Name) of the Key Management Service (KMS) key you provide for encryption. This is required if you do not want to use the Amazon Web Services owned KMS key. If you don't provide anything here, AWS Supply Chain uses the Amazon Web Services owned KMS key",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The namespace of the dataset. The available values are:   asc: for  AWS Supply Chain supported datasets .   default: for datasets with custom user-defined schemas",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--name",
                    description: "The name of the dataset. If the namespace is asc, the name must be one of the supported data entities",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--namespace",
                    description: "The name space of the dataset. The available values are:    asc - For information on the Amazon Web Services Supply Chain supported datasets see https://docs.aws.amazon.com/aws-supply-chain/latest/userguide/data-model-asc.html.    default - For datasets with custom user-defined schemas",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "Specify the maximum number of DataIntegrationFlows to fetch in one paginated request",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "Specify the maximum number of instances to fetch in this paginated request",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--data",
                    description: "The data payload of the event. For more information on the data schema to use, see Data entities supported in AWS Supply Chain",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--event-group-id",
                    description: "Event identifier (for example, orderId for InboundOrder) used for data sharing or partitioning",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tags",
                    description: "The tags of the Amazon Web Services Supply chain resource to be created",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--tag-keys",
                    description: "The list of tag keys to be deleted for an Amazon Web Services Supply Chain resource",
                    args: {
                        name: "list"
                    }
                },
