    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--hierarchy-id",
                    description: "The ID of a hierarchy in the parent asset's model. (This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide.) Hierarchies allow different groupings of assets to be formed that all come from the same asset model. For more information, see Asset hierarchies in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--child-asset-id",
                    description: "The ID of the child asset to be associated. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-id",
                    description: "The ID of the asset in which the asset property was created. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--property-id",
                    description: "The ID of the asset property. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-model-id",
                    description: "The ID of the asset model from which to create the asset. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--asset-id",
                    description: "The ID to assign to the asset, if desired. IoT SiteWise automatically generates a unique ID for you, so this parameter is never required. However, if you prefer to supply your own ID instead, you can specify it here in UUID format. If you specify your own ID, it must be globally unique",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "An external ID to assign to the asset. The external ID must be unique within your Amazon Web Services account. For more information, see Using external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The type of asset model.    ASSET_MODEL \u2013 (default) An asset model that you can use to create assets. Can't be included as a component in another asset model.    COMPONENT_MODEL \u2013 A reusable component that you can include in the composite models of other asset models. You can't create assets directly from this type of asset model",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--asset-model-id",
                    description: "The ID to assign to the asset model, if desired. IoT SiteWise automatically generates a unique ID for you, so this parameter is never required. However, if you prefer to supply your own ID instead, you can specify it here in UUID format. If you specify your own ID, it must be globally unique",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "An external ID to assign to the asset model. The external ID must be unique within your Amazon Web Services account. For more information, see Using external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The property definitions of the asset model. For more information, see Asset properties in the IoT SiteWise User Guide. You can specify up to 200 properties per asset model. For more information, see Quotas in the IoT SiteWise User Guide",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ID of the composite model. IoT SiteWise automatically generates a unique ID for you, so this parameter is never required. However, if you prefer to supply your own ID instead, you can specify it here in UUID format. If you specify your own ID, it must be globally unique",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The composite model type. Valid values are AWS/ALARM, CUSTOM, or  AWS/L4E_ANOMALY",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The property definitions of the composite model. For more information, see  Inline custom composite models in the IoT SiteWise User Guide. You can specify up to 200 properties per composite model. For more information, see Quotas in the IoT SiteWise User Guide",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "If set to true, ingest new data into IoT SiteWise storage. Measurements with notifications, metrics and transforms are computed. If set to false, historical data is ingested into IoT SiteWise as is"
                },
                {
                ...
                },
                {
                    ...
                    description: "If set to true, your data files is deleted from S3, after ingestion into IoT SiteWise storage"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The dashboard definition specified in a JSON literal.   IoT SiteWise Monitor (Classic) see Create dashboards (CLI)    IoT SiteWise Monitor (AI-aware) see Create dashboards (CLI)    in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The email address that sends alarm notifications.  If you use the IoT Events managed Lambda function to manage your emails, you must verify the sender email address in Amazon SES",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--if-none-match",
                    description: "Accepts * to reject the delete request if an active version (specified using matchForVersionType as ACTIVE) already exists for the asset model",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--match-for-version-type",
                    description: "Specifies the asset model version type (LATEST or ACTIVE) used in conjunction with If-Match or If-None-Match headers to determine the target ETag for the delete operation",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The ID of a composite model on this asset. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The version alias that specifies the latest or active version of the asset model. The details are returned in the response. The default value is LATEST. See  Asset model versions in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-model-composite-model-id",
                    description: "The ID of a composite model on this asset model. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--hierarchy-id",
                    description: "The ID of a hierarchy in the parent asset's model. (This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide.) Hierarchies allow different groupings of assets to be formed that all come from the same asset model. You can use the hierarchy ID to identify the correct asset to disassociate. For more information, see Asset hierarchies in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--child-asset-id",
                    description: "The ID of the child asset to disassociate. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--max-results",
                    description: "The maximum number of results to return for each paginated request. Default: 50",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filter",
                    description: "Filters the requested list of asset model properties. You can choose one of the following options:    ALL \u2013 The list includes all asset model properties for a given asset model ID.     BASE \u2013 The list includes only base asset model properties for a given asset model ID.    Default: BASE",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--filter",
                    description: "Filters the requested list of asset properties. You can choose one of the following options:    ALL \u2013 The list includes all asset properties for a given asset model ID.     BASE \u2013 The list includes only base asset properties for a given asset model ID.    Default: BASE",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The direction to list associated assets. Choose one of the following options:    CHILD \u2013 The list includes all child assets associated to the asset.    PARENT \u2013 The list includes the asset's parent asset.   Default: CHILD",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The type of the time series. The time series type can be one of the following values:    ASSOCIATED \u2013 The time series is associated with an asset property.    DISASSOCIATED \u2013 The time series isn't associated with any asset property",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The number of days your data is kept in the hot tier. By default, your data is kept indefinitely in the hot tier",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--warm-tier",
                    description: "A service managed storage tier optimized for analytical queries. It stores periodically uploaded, buffered and historical data ingested with the CreaeBulkImportJob API",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "Set this period to specify how long your data is stored in the warm tier before it is deleted. You can set this only if cold tier is enabled",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-external-id",
                    description: "An external ID to assign to the asset. The asset must not already have an external ID. The external ID must be unique within your Amazon Web Services account. For more information, see Using external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-model-external-id",
                    description: "An external ID to assign to the asset model. The asset model must not already have an external ID. The external ID must be unique within your Amazon Web Services account. For more information, see Using external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--asset-model-properties",
                    description: "The updated property definitions of the asset model. For more information, see Asset properties in the IoT SiteWise User Guide. You can specify up to 200 properties per asset model. For more information, see Quotas in the IoT SiteWise User Guide",
                    args: {
                        name: "list"
                    }
                },
                ...
                {
                    name: "--if-none-match",
                    description: "Accepts * to reject the update request if an active version (specified using matchForVersionType as ACTIVE) already exists for the asset model",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--match-for-version-type",
                    description: "Specifies the asset model version type (LATEST or ACTIVE) used in conjunction with If-Match or If-None-Match headers to determine the target ETag for the update operation",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--asset-model-composite-model-external-id",
                    description: "An external ID to assign to the asset model. You can only set the external ID of the asset model if it wasn't set when it was created, or you're setting it to the exact same thing as when it was created",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--property-id",
                    description: "The ID of the asset property to be updated. This can be either the actual ID in UUID format, or else externalId: followed by the external ID, if it has one. For more information, see Referencing objects with external IDs in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The MQTT notification state (enabled or disabled) for this asset property. When the notification state is enabled, IoT SiteWise publishes property value updates to a unique MQTT topic. For more information, see Interacting with other services in the IoT SiteWise User Guide. If you omit this parameter, the notification state is set to DISABLED",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--dashboard-definition",
                    description: "The new dashboard definition, as specified in a JSON literal.   IoT SiteWise Monitor (Classic) see Create dashboards (CLI)    IoT SiteWise Monitor (AI-aware) see Create dashboards (CLI)    in the IoT SiteWise User Guide",
                    args: {
                        name: "string"
                    }
                },
