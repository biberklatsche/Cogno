    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--from-date",
                    description: "This target has been deprecated. The start date from which to retrieve the data set in UTC. This parameter only affects the customer_support_contacts_data data set type",
                    args: {
                        name: "timestamp"
                    }
                },
                {
                    name: "--role-name-arn",
                    description: "This target has been deprecated. The Amazon Resource Name (ARN) of the Role with an attached permissions policy to interact with the provided AWS services",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--destination-s3-bucket-name",
                    description: "This target has been deprecated. The name (friendly name, not ARN) of the destination S3 bucket",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--destination-s3-prefix",
                    description: 'This target has been deprecated. (Optional) The desired S3 prefix for the published data set, similar to a directory path in standard file systems. For example, if given the bucket name "mybucket" and the prefix "myprefix/mydatasets", the output file "outputfile" would be published to "s3://mybucket/myprefix/mydatasets/outputfile". If the prefix directory structure does not exist, it will be created. If no prefix is provided, the data set will be published to the S3 bucket root',
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--sns-topic-arn",
                    description: "This target has been deprecated. Amazon Resource Name (ARN) for the SNS Topic that will be notified when the data set has been published or if an error has occurred",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--customer-defined-values",
                    description: "This target has been deprecated. (Optional) Key-value pairs which will be returned, unmodified, in the Amazon SNS notification message and the data set metadata file",
                    args: {
                        name: "map"
                    }
                },
