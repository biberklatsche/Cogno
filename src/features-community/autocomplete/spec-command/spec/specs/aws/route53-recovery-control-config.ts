      ...
      subcommands: [
        {
          ...
          description:
            "Wait until a cluster is created It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--cluster-arn",
              description: "The Amazon Resource Name (ARN) of the cluster",
        ...
        },
        {
          ...
          description:
            "Wait for a cluster to be deleted It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--cluster-arn",
              description: "The Amazon Resource Name (ARN) of the cluster",
        ...
        },
        {
          ...
          description:
            "Wait until a control panel is created It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--control-panel-arn",
              description:
        ...
        },
        {
          ...
          description:
            "Wait until a control panel is deleted It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--control-panel-arn",
              description:
        ...
        },
        {
          ...
          description:
            "Wait until a routing control is created It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--routing-control-arn",
              description:
        ...
        },
        {
          ...
          description:
            "Wait for a routing control to be deleted It will poll every 5 seconds until a successful state has been reached. This will exit with a return code of 255 after 26 failed checks",
          options: [
            {
              name: "--routing-control-arn",
              description:
