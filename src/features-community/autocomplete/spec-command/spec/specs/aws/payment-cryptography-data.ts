    ...
    subcommands: [
        {
            ...
            options: [
                {
                    name: "--key-identifier",
                    description: "The keyARN of the encryption key that Amazon Web Services Payment Cryptography uses for ciphertext decryption. When a WrappedKeyBlock is provided, this value will be the identifier to the key wrapping key. Otherwise, it is the key identifier used to perform the operation",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--wrapped-key",
                    description: "The WrappedKeyBlock containing the encryption key for ciphertext decryption",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--wrapped-key",
                    description: "The WrappedKeyBlock containing the encryption key for plaintext encryption",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--message-data",
                    description: "The data for which a MAC is under generation. This value must be hexBinary",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The attributes and data values to derive payment card specific confidentiality and integrity keys",
                    args: {
                        name: "structure"
                    }
                },
            ...
            options: [
                {
                    ...
                    description: "The keyARN of the PEK that Amazon Web Services Payment Cryptography uses for pin data generation",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The keyARN of the PEK that Amazon Web Services Payment Cryptography uses to encrypt the PIN Block. For ECDH, it is the keyARN of the asymmetric ECC key",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "The keyARN of the encryption key of outgoing ciphertext data after encryption by Amazon Web Services Payment Cryptography",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The WrappedKeyBlock containing the encryption key of incoming ciphertext data",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "The WrappedKeyBlock containing the encryption key of outgoing ciphertext data after encryption by Amazon Web Services Payment Cryptography",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            options: [
                {
                    name: "--incoming-key-identifier",
                    description: "The keyARN of the encryption key under which incoming PIN block data is encrypted. This key type can be PEK or BDK. For dynamic keys, it is the keyARN of KEK of the TR-31 wrapped PEK. For ECDH, it is the keyARN of the asymmetric ECC key",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--outgoing-key-identifier",
                    description: "The keyARN of the encryption key for encrypting outgoing PIN block data. This key type can be PEK or BDK. For ECDH, it is the keyARN of the asymmetric ECC key",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "The format of the incoming PIN block data for translation within Amazon Web Services Payment Cryptography",
                    args: {
                        name: "structure"
                    }
                },
                {
                    ...
                    description: "The format of the outgoing PIN block data after translation by Amazon Web Services Payment Cryptography",
                    args: {
                        name: "structure"
                    }
                },
                ...
                },
                {
                    ...
                    description: "The attributes and values to use for incoming DUKPT encryption key for PIN block translation",
                    args: {
                        name: "structure"
                    }
                },
                ...
                {
                    name: "--incoming-wrapped-key",
                    description: "The WrappedKeyBlock containing the encryption key under which incoming PIN block data is encrypted",
                    args: {
                        name: "structure"
                    }
                },
                {
                    name: "--outgoing-wrapped-key",
                    description: "The WrappedKeyBlock containing the encryption key for encrypting outgoing PIN block data",
                    args: {
                        name: "structure"
                    }
                },
        ...
        },
        {
            ...
            description: "Verifies Authorization Request Cryptogram (ARQC) for a EMV chip payment card authorization. For more information, see Verify auth request cryptogram in the Amazon Web Services Payment Cryptography User Guide. ARQC generation is done outside of Amazon Web Services Payment Cryptography and is typically generated on a point of sale terminal for an EMV chip card to obtain payment authorization during transaction time. For ARQC verification, you must first import the ARQC generated outside of Amazon Web Services Payment Cryptography by calling ImportKey. This operation uses the imported ARQC and an major encryption key (DUKPT) created by calling CreateKey to either provide a boolean ARQC verification result or provide an APRC (Authorization Response Cryptogram) response using Method 1 or Method 2. The ARPC_METHOD_1 uses AuthResponseCode to generate ARPC and ARPC_METHOD_2 uses CardStatusUpdate to generate ARPC.  For information about valid keys for this operation, see Understanding key attributes and Key types for specific data operations in the Amazon Web Services Payment Cryptography User Guide.  Cross-account use: This operation can't be used across different Amazon Web Services accounts.  Related operations:     VerifyCardValidationData     VerifyPinData",
            options: [
                {
                    name: "--key-identifier",
                    description: "The keyARN of the major encryption key that Amazon Web Services Payment Cryptography uses for ARQC verification",
                    args: {
                        name: "string"
                    }
                },
        ...
        {
            name: "verify-mac",
            description: "Verifies a Message Authentication Code (MAC).  You can use this operation to verify MAC for message data authentication such as . In this operation, you must use the same message data, secret encryption key and MAC algorithm that was used to generate MAC. You can use this operation to verify a DUPKT, CMAC, HMAC or EMV MAC by setting generation attributes and algorithm to the associated values.  For information about valid keys for this operation, see Understanding key attributes and Key types for specific data operations in the Amazon Web Services Payment Cryptography User Guide.   Cross-account use: This operation can't be used across different Amazon Web Services accounts.  Related operations:     GenerateMac",
            options: [
                {
                    name: "--key-identifier",
                    description: "The keyARN of the encryption key that Amazon Web Services Payment Cryptography uses to verify MAC data",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--message-data",
                    description: "The data on for which MAC is under verification. This value must be hexBinary",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--encryption-key-identifier",
                    description: "The keyARN of the encryption key under which the PIN block data is encrypted. This key type can be PEK or BDK",
                    args: {
                        name: "string"
                    }
                },
