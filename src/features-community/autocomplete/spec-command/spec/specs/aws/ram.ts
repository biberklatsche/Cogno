    ...
    subcommands: [
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arns",
                    description: "Specifies a list of Amazon Resource Names (ARNs) of the resources that you want to share. This can be null if you want to add only principals",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--permission-arn",
                    description: "Specifies the Amazon Resource Name (ARN) of the RAM permission to associate with the resource share. To find the ARN for a permission, use either the ListPermissions operation or go to the Permissions library page in the RAM console and then choose the name of the permission. The ARN is displayed on the detail page",
                    args: {
                        name: "string"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Specifies the version of the RAM permission to associate with the resource share. You can specify only the version that is currently set as the default version for the permission. If you also set the replace pararameter to true, then this operation updates an outdated version of the permission to the current default version.  You don't need to specify this parameter because the default behavior is to use the version that is currently set as the default version for the permission. This parameter is supported for backwards compatibility",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--principals",
                    description: "Specifies a list of one or more principals to associate with the resource share. You can include the following values:   An Amazon Web Services account ID, for example: 123456789012    An Amazon Resource Name (ARN) of an organization in Organizations, for example: organizations::123456789012:organization/o-exampleorgid    An ARN of an organizational unit (OU) in Organizations, for example: organizations::123456789012:ou/o-exampleorgid/ou-examplerootid-exampleouid123    An ARN of an IAM role, for example: iam::123456789012:role/rolename    An ARN of an IAM user, for example: iam::123456789012user/username     Not all resource types can be shared with IAM roles and users. For more information, see Sharing with IAM roles and users in the Resource Access Manager User Guide",
                    args: {
                        name: "list"
                    }
                },
                ...
                },
                {
                    ...
                    description: "Specifies whether principals outside your organization in Organizations can be associated with a resource share. A value of true lets you share with individual Amazon Web Services accounts that are not in your organization. A value of false only has meaning if your account is a member of an Amazon Web Services Organization. The default value is true"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arns",
                    description: "Specifies a list of Amazon Resource Names (ARNs) for one or more resources that you want to remove from the resource share. After the operation runs, these resources are no longer shared with principals associated with the resource share",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--principals",
                    description: "Specifies a list of one or more principals that no longer are to have access to the resources in this resource share. You can include the following values:   An Amazon Web Services account ID, for example: 123456789012    An Amazon Resource Name (ARN) of an organization in Organizations, for example: organizations::123456789012:organization/o-exampleorgid    An ARN of an organizational unit (OU) in Organizations, for example: organizations::123456789012:ou/o-exampleorgid/ou-examplerootid-exampleouid123    An ARN of an IAM role, for example: iam::123456789012:role/rolename    An ARN of an IAM user, for example: iam::123456789012user/username     Not all resource types can be shared with IAM roles and users. For more information, see Sharing with IAM roles and users in the Resource Access Manager User Guide",
                    args: {
                        name: "list"
                    }
                },
                ...
                {
                    name: "--sources",
                    description: "Specifies from which source accounts the service principal no longer has access to the resources in this resource share",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--permission-arn",
                    description: "The Amazon Resource Name (ARN) of the managed permission to disassociate from the resource share. Changes to permissions take effect immediately",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--permission-version",
                    description: "Specifies the version number of the RAM permission to retrieve. If you don't specify this parameter, the operation retrieves the default version. To see the list of available versions, use ListPermissionVersions",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies a list of Amazon Resource Names (ARNs) of the resource share whose associations you want to retrieve",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--resource-arn",
                    description: "Specifies the Amazon Resource Name (ARN) of a resource whose resource shares you want to retrieve. You cannot specify this parameter if the association type is PRINCIPAL",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-share-arns",
                    description: "Specifies that you want details about invitations only for the resource shares described by this list of Amazon Resource Names (ARNs)",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-owner",
                    description: "Specifies that you want to retrieve details of only those resource shares that match the following:     SELF  \u2013 resource shares that your account shares with other accounts     OTHER-ACCOUNTS  \u2013 resource shares that other accounts share with your account",
                    args: {
                        name: "string"
                    }
                },
                ...
                {
                    name: "--permission-arn",
                    description: "Specifies that you want to retrieve details of only those resource shares that use the managed permission with this Amazon Resource Name (ARN)",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies that you want the results to include only resources that have the specified scope.    ALL \u2013 the results include both global and regional resources or resource types.    GLOBAL \u2013 the results include only global resources or resource types.    REGIONAL \u2013 the results include only regional resources or resource types.   The default value is ALL",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--feature-set",
                    description: "Specifies that you want to list only those associations with resource shares that have a featureSet with this value",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "When true, specifies that you want to list only those associations with resource shares that use the default version of the specified managed permission. When false (the default value), lists associations with resource shares that use any version of the specified managed permission"
                },
                {
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies that you want to list only permissions of this type:    AWS \u2013 returns only Amazon Web Services managed permissions.    LOCAL \u2013 returns only customer managed permissions    ALL \u2013 returns both Amazon Web Services managed permissions and customer managed permissions.   If you don't specify this parameter, the default is All",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arn",
                    description: "Specifies that you want to list principal information for the resource share with the specified Amazon Resource Name (ARN)",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--principals",
                    description: "Specifies that you want to list information for only the listed principals. You can include the following values:   An Amazon Web Services account ID, for example: 123456789012    An Amazon Resource Name (ARN) of an organization in Organizations, for example: organizations::123456789012:organization/o-exampleorgid    An ARN of an organizational unit (OU) in Organizations, for example: organizations::123456789012:ou/o-exampleorgid/ou-examplerootid-exampleouid123    An ARN of an IAM role, for example: iam::123456789012:role/rolename    An ARN of an IAM user, for example: iam::123456789012user/username     Not all resource types can be shared with IAM roles and users. For more information, see Sharing with IAM roles and users in the Resource Access Manager User Guide",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--resource-type",
                    description: "Specifies that you want to list information for only principals associated with resource shares that include the specified resource type. For a list of valid values, query the ListResourceTypes operation",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--resource-share-arns",
                    description: "Specifies that you want to list information for only principals associated with the resource shares specified by a list the Amazon Resource Names (ARNs)",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-type",
                    description: "Specifies that you want to list only the resource shares that include resources of the specified resource type. For valid values, query the ListResourceTypes operation",
                    args: {
                        name: "string"
                    }
                },
                {
                    name: "--resource-arns",
                    description: "Specifies that you want to list only the resource shares that include resources with the specified Amazon Resource Names (ARNs)",
                    args: {
                        name: "list"
                    }
                },
                {
                    name: "--resource-share-arns",
                    description: "Specifies that you want to list only resources in the resource shares identified by the specified Amazon Resource Names (ARNs)",
                    args: {
                        name: "list"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "Specifies the ARN of the managed permission that you want to associate with resource shares in place of the one specified by fromPerssionArn and fromPermissionVersion. The operation always associates the version that is currently the default for the specified managed permission",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--permission-version",
                    description: "Specifies the version number that you want to designate as the default for customer managed permission. To see a list of all available version numbers, use ListPermissionVersions",
                    args: {
                        name: "integer"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arn",
                    description: "Specifies the Amazon Resource Name (ARN) of the managed permission that you want to add tags to. You must specify either resourceArn, or resourceShareArn, but not both",
                    args: {
                        name: "string"
                    }
                },
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--resource-arn",
                    description: "Specifies the Amazon Resource Name (ARN) of the managed permission that you want to remove tags from. You must specify either resourceArn, or resourceShareArn, but not both",
                    args: {
                        name: "string"
                    }
                },
