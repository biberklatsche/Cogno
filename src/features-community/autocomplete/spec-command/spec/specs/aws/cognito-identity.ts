...
const completionSpec: CommandSpec = {
    ...
    subcommands: [
        ...
        },
        {
            ...
            description: "Deletes an identity pool. Once a pool is deleted, users will not be able to authenticate with the pool. You must use AWS Developer credentials to call this API",
            options: [
                {
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "--logins",
                    description: "A set of optional name-value pairs that map provider names to provider tokens. The available provider names for Logins are as follows:   Facebook: graph.facebook.com    Amazon Cognito user pool: cognito-idp.<region>.amazonaws.com/<YOUR_USER_POOL_ID>, for example, cognito-idp.us-east-1.amazonaws.com/us-east-1_123456789.    Google: accounts.google.com    Amazon: www.amazon.com    Twitter: api.twitter.com    Digits: www.digits.com",
                    args: {
                        name: "map"
                    }
                },
        ...
        },
        {
            ...
            description: "Lists the identities in an identity pool. You must use AWS Developer credentials to call this API",
            options: [
                {
                    name: "--identity-pool-id",
                    description: "An identity pool ID in the format REGION:GUID",
        ...
        },
        {
            ...
            description: "Sets the roles for an identity pool. These roles are used when making calls to GetCredentialsForIdentity action. You must use AWS Developer credentials to call this API",
            options: [
                {
                    name: "--identity-pool-id",
                    description: "An identity pool ID in the format REGION:GUID",
        ...
        },
        {
            ...
            description: "Updates an identity pool. You must use AWS Developer credentials to call this API",
            options: [
                {
                    name: "--identity-pool-id",
                    description: "An identity pool ID in the format REGION:GUID",
