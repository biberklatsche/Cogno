    ...
    subcommands: [
        {
            ...
            options: [
                ...
                {
                    name: "--body",
                    description: "Provides input data, in the format specified in the ContentType request header. Amazon SageMaker passes all of the data in the body to the model.  For information about the format of the request body, see Common Data Formats-Inference",
                    args: {
                        name: "blob"
                    }
                },
                ...
                },
                {
                    ...
                    description: "An optional JMESPath expression used to override the EnableExplanations parameter of the ClarifyExplainerConfig API. See the EnableExplanations section in the developer guide for more information",
                    args: {
                        name: "string"
                    }
                },
                {
                    ...
                    description: "If the endpoint hosts one or more inference components, this parameter specifies the name of inference component to invoke",
                    args: {
                        name: "string"
                    }
                },
